...
//
// ----------------------------------------------
// METODOS          : CAPEX ADJUNTOS /DOCUMENTOS
...
FNLimpiarEvaluacionEconomica = function () {
    ...
    $("#EveTir").val("0%");
    $('#frame5').attr('src', $('#frame5').attr('src'));
    if (($('#BotonGuardarEvaluacionEconomica').length > 0) || ($('#BotonActualizarEvaluacionEconomica').length > 0)) {
...
FNLimpiarEvaluacionRiesgo = function () {
    ...
    $("#EvrMFL2").val("0.00");
    $('#frame6').attr('src', $('#frame6').attr('src'));
    if (($('#BotonGuardarEvaluacionRiesgo').length > 0) || ($('#BotonActualizarEvaluacionRiesgo').length > 0)) {
