...
FNFormatearReglaDosEvalEco = function (nStr) {
    ...
    tir = tir.replace("0", "")
    if (!tir || tir == undefined || tir == "") {
        tir = "0";
    }
    console.log("FNFormatearReglaDosEvalEco tir=", tir);
    return tir + "%";
}
...
FNPreviousCallBackIngresoEvaluacionEconomicaCheckToken = function () {
...
FNPreviousCallBackIngresoEvaluacionEconomica = function () {
    console.log("FNPreviousCallBackIngresoEvaluacionEconomica");
    jQuery("#AppLoaderContainer").show();
}

FNCallBackIngresoEvaluacionEconomica = function (paramJson) {
    jQuery("#AppLoaderContainer").hide();
