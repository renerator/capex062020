...
namespace Capex.Web.Controllers
{
    ...
    public class OrientacionController : Controller
    {
        ...
        public static decimal staticStringToDecimal(string paramValue)
        {
            try
            {
                return decimal.Parse(staticStringNumberFormat(paramValue), NumberStyles.Number | NumberStyles.AllowExponent);
            }
            catch (Exception err)
            {
                err.ToString();
        ...
        public static string staticStringNumberFormat(string paramValue)
        {
        ...
        private string stringNumberFormatFromDB(string paramValue)
        {
            if (!string.IsNullOrEmpty(paramValue))
            {
                if (paramValue.IndexOf(".") != -1 && paramValue.IndexOf(",") != -1)
        ...
        /*static public void Main(String[] args)
        {
            ...
            decimal convertNumberPunto = staticStringToDecimal("11.797235023041474654377880185");
            Console.WriteLine("convertNumberPunto=" + convertNumberPunto);

            decimal convertNumberComa = staticStringToDecimal("11,797235023041474654377880185");
            Console.WriteLine("convertNumberComa=" + convertNumberComa);
        }*/
        ...
        private void GenerarVersionParametroVNToken(SqlConnection objConnection, string ParametroVNToken)
        {
            try
            {
                    ...
                    if (Iniciativas != null && Iniciativas.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            foreach (var iniciativa in Iniciativas)
                            {
                                ...
                                if (string.IsNullOrEmpty(iniToken))
                                {
                                    continue;
                                }
                                var paramIniTokenRemanente = new DynamicParameters();
                                paramIniTokenRemanente.Add("IniToken", iniToken);
                                ...
                                {
                                    //CASO DE INICIATIVA ES REMANENTE
                                    var parametrosInsertInciativaRemanante = new DynamicParameters();
                                    parametrosInsertInciativaRemanante.Add("IniToken", iniToken);
                                    parametrosInsertInciativaRemanante.Add("IniUsuario", usuario);
                                    parametrosInsertInciativaRemanante.Add("ParametroVNToken", parametroVNToken);
                                    parametrosInsertInciativaRemanante.Add("TipoIniciativa", tipoIniciativaOrientacionComercial);
                                    SqlMapper.Execute(objConnection, "CAPEX_INS_INICIATIVA_REMANENTE", parametrosInsertInciativaRemanante, commandType: CommandType.StoredProcedure);
                                }
                                else
                                {
                                    //CASO DE INICIATIVA DISTINTA A REMANENTE
                                    ...
                                    if (existeImportacionFinanciero != null && !string.IsNullOrEmpty(existeImportacionFinanciero.Trim()) && "0".Equals(existeImportacionFinanciero.Trim()))
                                    {
                                        ...
                                        if (importacionFinancieroParametroVNOrigen != null && importacionFinancieroParametroVNOrigen.Count > 0)
                                        {
                                            ...
                                            {
                                                string IfTokenParam = impFinOrigen.IfToken;
                                                string IfDato0Param = impFinOrigen.IfDato0;
                                                decimal perAntTotal = stringToDecimalFromDB(impFinOrigen.IfDato2);
                                                if ("1".Equals(tipoIniciativaOrientacionComercial)) // caso base
                                                {
                                                    IList<Presupuesto.FinancieroDetalleCasoBase> informacionFinancieroDetalleParametroVNOrigen = SqlMapper.Query<Presupuesto.FinancieroDetalleCasoBase>(objConnection, "CAPEX_SEL_IMPORTACION_FINANCIERO_DETALLE_PARAMETROVN", new { TipoIniciativa = tipoIniciativaOrientacionComercial, IfToken = IfTokenParam }, commandType: CommandType.StoredProcedure).ToList();
                                                    if (IfDato0Param.StartsWith(prefixTA) && (informacionFinancieroDetalleParametroVNOrigen == null || informacionFinancieroDetalleParametroVNOrigen.Count == 0))
                                                    {
                                                        totAcumMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param });
                                                    }
                                                    else if (informacionFinancieroDetalleParametroVNOrigen != null && informacionFinancieroDetalleParametroVNOrigen.Count == 2)
                                                    {
                                                        ...
                                                        {
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDato2.ToString());
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato2.ToString());
                                                            ingMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDato0.ToString() });
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            //Octubre
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            //Noviembre
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            ...
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas2
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas3
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas4
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato19) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato19) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas5
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato20) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato20) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas6
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato21) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato21) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas7
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato22) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato22) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas8
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato23) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato23) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas9
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato24) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato24) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas10
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato25) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato25) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas11
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato26) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato26) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas12
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato27) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato27) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas13
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato28) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato28) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas14
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato29) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato29) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas15
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato30) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato30) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas16
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato31) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato31) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas17
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato32) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato32) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas18
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato33) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato33) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas19
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato34) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato34) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas20
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato35) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato35) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas21
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato36) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato36) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas22
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato37) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato37) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas23
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato38) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato38) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas24
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato39) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato39) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas25
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato40) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato40) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas26
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato41) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato41) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas27
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato42) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato42) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas28
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato43) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato43) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas29
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato44) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato44) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas30
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato45) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato45) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas31
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato46) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato46) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas32
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato47) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato47) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas33
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato48) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato48) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas34
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato49) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato49) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas35
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato50) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato50) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas36
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato51) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato51) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas37
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato52) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato52) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas38
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato53) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato53) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas39
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato54) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato54) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas40
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato55) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato55) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas41
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato56) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato56) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas42
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato57) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato57) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas43
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato58) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato58) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas44
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato59) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato59) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas45
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato60) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato60) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas46
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato61) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato61) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas47
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato62) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato62) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas48
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato63) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato63) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas49
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato64) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato64) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas50
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato65) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato65) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas51
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato66) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato66) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas52
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato67) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato67) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas53
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato68) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato68) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas54
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato69) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato69) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas55
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato70) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato70) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas56
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato71) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato71) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas57
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato72) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato72) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas58
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato73) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato73) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas59
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato74) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato74) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas60
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato75) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato75) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas61
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato76) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato76) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas62
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato77) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato77) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas63
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato78) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato78) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas64
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato79) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato79) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas65
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato80) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato80) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas66
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato81) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato81) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas67
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato82) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato82) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas68
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato83) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato83) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas69
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato84) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato84) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas70
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato85) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato85) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas71
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato86) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato86) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas72
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato87) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato87) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas73
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato88) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato88) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas74
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato89) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato89) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas75
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato90) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato90) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas76
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato91) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato91) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas77
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato92) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato92) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas78
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato93) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato93) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas79
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato94) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato94) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas80
                                                            ...
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato95) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato95) * facCorrMonExt, ValorTotal = 0 });
                                                            //Total por año
                                                        ...
                                                        {
                                                            adqMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDato0, TituloExt = filaMonedaExtranjera.IfDato0 });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato2);
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = perAntNac, ValorExt = perAntExt, ValorTotal = perAntTotal });
                                                            //Enero
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            //Octubre
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            //Noviembre
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            //Calculo Totales por Mes
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas2
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas3
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas4
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[3].Value) || decimalIsZero(orientacionComercialTCAnioDestino[3].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[3].Value / orientacionComercialIPCAnioOrigen[3].Value) * (orientacionComercialTCAnioOrigen[3].Value / orientacionComercialTCAnioDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[3].Value)) ? 0 : (orientacionComercialCPIAnioDestino[3].Value / orientacionComercialCPIAnioOrigen[3].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato19) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato19) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas5
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[4].Value) || decimalIsZero(orientacionComercialTCAnioDestino[4].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[4].Value / orientacionComercialIPCAnioOrigen[4].Value) * (orientacionComercialTCAnioOrigen[4].Value / orientacionComercialTCAnioDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[4].Value)) ? 0 : (orientacionComercialCPIAnioDestino[4].Value / orientacionComercialCPIAnioOrigen[4].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato20) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato20) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas6
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[5].Value) || decimalIsZero(orientacionComercialTCAnioDestino[5].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[5].Value / orientacionComercialIPCAnioOrigen[5].Value) * (orientacionComercialTCAnioOrigen[5].Value / orientacionComercialTCAnioDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[5].Value)) ? 0 : (orientacionComercialCPIAnioDestino[5].Value / orientacionComercialCPIAnioOrigen[5].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato21) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato21) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas7
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[6].Value) || decimalIsZero(orientacionComercialTCAnioDestino[6].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[6].Value / orientacionComercialIPCAnioOrigen[6].Value) * (orientacionComercialTCAnioOrigen[6].Value / orientacionComercialTCAnioDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[6].Value)) ? 0 : (orientacionComercialCPIAnioDestino[6].Value / orientacionComercialCPIAnioOrigen[6].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato22) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato22) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas8
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[7].Value) || decimalIsZero(orientacionComercialTCAnioDestino[7].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[7].Value / orientacionComercialIPCAnioOrigen[7].Value) * (orientacionComercialTCAnioOrigen[7].Value / orientacionComercialTCAnioDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[7].Value)) ? 0 : (orientacionComercialCPIAnioDestino[7].Value / orientacionComercialCPIAnioOrigen[7].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato23) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato23) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas9
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[8].Value) || decimalIsZero(orientacionComercialTCAnioDestino[8].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[8].Value / orientacionComercialIPCAnioOrigen[8].Value) * (orientacionComercialTCAnioOrigen[8].Value / orientacionComercialTCAnioDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[8].Value)) ? 0 : (orientacionComercialCPIAnioDestino[8].Value / orientacionComercialCPIAnioOrigen[8].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato24) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato24) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas10
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[9].Value) || decimalIsZero(orientacionComercialTCAnioDestino[9].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[9].Value / orientacionComercialIPCAnioOrigen[9].Value) * (orientacionComercialTCAnioOrigen[9].Value / orientacionComercialTCAnioDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[9].Value)) ? 0 : (orientacionComercialCPIAnioDestino[9].Value / orientacionComercialCPIAnioOrigen[9].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato25) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato25) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas11
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[10].Value) || decimalIsZero(orientacionComercialTCAnioDestino[10].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[10].Value / orientacionComercialIPCAnioOrigen[10].Value) * (orientacionComercialTCAnioOrigen[10].Value / orientacionComercialTCAnioDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[10].Value)) ? 0 : (orientacionComercialCPIAnioDestino[10].Value / orientacionComercialCPIAnioOrigen[10].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato26) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato26) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas12
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[11].Value) || decimalIsZero(orientacionComercialTCAnioDestino[11].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[11].Value / orientacionComercialIPCAnioOrigen[11].Value) * (orientacionComercialTCAnioOrigen[11].Value / orientacionComercialTCAnioDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[11].Value)) ? 0 : (orientacionComercialCPIAnioDestino[11].Value / orientacionComercialCPIAnioOrigen[11].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato27) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato27) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas13
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[12].Value) || decimalIsZero(orientacionComercialTCAnioDestino[12].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[12].Value / orientacionComercialIPCAnioOrigen[12].Value) * (orientacionComercialTCAnioOrigen[12].Value / orientacionComercialTCAnioDestino[12].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[12].Value)) ? 0 : (orientacionComercialCPIAnioDestino[12].Value / orientacionComercialCPIAnioOrigen[12].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato28) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato28) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas14
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[13].Value) || decimalIsZero(orientacionComercialTCAnioDestino[13].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[13].Value / orientacionComercialIPCAnioOrigen[13].Value) * (orientacionComercialTCAnioOrigen[13].Value / orientacionComercialTCAnioDestino[13].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[13].Value)) ? 0 : (orientacionComercialCPIAnioDestino[13].Value / orientacionComercialCPIAnioOrigen[13].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato29) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato29) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas15
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[14].Value) || decimalIsZero(orientacionComercialTCAnioDestino[14].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[14].Value / orientacionComercialIPCAnioOrigen[14].Value) * (orientacionComercialTCAnioOrigen[14].Value / orientacionComercialTCAnioDestino[14].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[14].Value)) ? 0 : (orientacionComercialCPIAnioDestino[14].Value / orientacionComercialCPIAnioOrigen[14].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato30) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato30) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas16
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[15].Value) || decimalIsZero(orientacionComercialTCAnioDestino[15].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[15].Value / orientacionComercialIPCAnioOrigen[15].Value) * (orientacionComercialTCAnioOrigen[15].Value / orientacionComercialTCAnioDestino[15].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[15].Value)) ? 0 : (orientacionComercialCPIAnioDestino[15].Value / orientacionComercialCPIAnioOrigen[15].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato31) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato31) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas17
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[16].Value) || decimalIsZero(orientacionComercialTCAnioDestino[16].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[16].Value / orientacionComercialIPCAnioOrigen[16].Value) * (orientacionComercialTCAnioOrigen[16].Value / orientacionComercialTCAnioDestino[16].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[16].Value)) ? 0 : (orientacionComercialCPIAnioDestino[16].Value / orientacionComercialCPIAnioOrigen[16].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato32) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato32) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas18
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[17].Value) || decimalIsZero(orientacionComercialTCAnioDestino[17].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[17].Value / orientacionComercialIPCAnioOrigen[17].Value) * (orientacionComercialTCAnioOrigen[17].Value / orientacionComercialTCAnioDestino[17].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[17].Value)) ? 0 : (orientacionComercialCPIAnioDestino[17].Value / orientacionComercialCPIAnioOrigen[17].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato33) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato33) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas19
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[18].Value) || decimalIsZero(orientacionComercialTCAnioDestino[18].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[18].Value / orientacionComercialIPCAnioOrigen[18].Value) * (orientacionComercialTCAnioOrigen[18].Value / orientacionComercialTCAnioDestino[18].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[18].Value)) ? 0 : (orientacionComercialCPIAnioDestino[18].Value / orientacionComercialCPIAnioOrigen[18].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato34) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato34) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas20
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[19].Value) || decimalIsZero(orientacionComercialTCAnioDestino[19].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[19].Value / orientacionComercialIPCAnioOrigen[19].Value) * (orientacionComercialTCAnioOrigen[19].Value / orientacionComercialTCAnioDestino[19].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[19].Value)) ? 0 : (orientacionComercialCPIAnioDestino[19].Value / orientacionComercialCPIAnioOrigen[19].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato35) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato35) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas21
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[20].Value) || decimalIsZero(orientacionComercialTCAnioDestino[20].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[20].Value / orientacionComercialIPCAnioOrigen[20].Value) * (orientacionComercialTCAnioOrigen[20].Value / orientacionComercialTCAnioDestino[20].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[20].Value)) ? 0 : (orientacionComercialCPIAnioDestino[20].Value / orientacionComercialCPIAnioOrigen[20].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato36) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato36) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas22
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[21].Value) || decimalIsZero(orientacionComercialTCAnioDestino[21].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[21].Value / orientacionComercialIPCAnioOrigen[21].Value) * (orientacionComercialTCAnioOrigen[21].Value / orientacionComercialTCAnioDestino[21].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[21].Value)) ? 0 : (orientacionComercialCPIAnioDestino[21].Value / orientacionComercialCPIAnioOrigen[21].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato37) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato37) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas23
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[22].Value) || decimalIsZero(orientacionComercialTCAnioDestino[22].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[22].Value / orientacionComercialIPCAnioOrigen[22].Value) * (orientacionComercialTCAnioOrigen[22].Value / orientacionComercialTCAnioDestino[22].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[22].Value)) ? 0 : (orientacionComercialCPIAnioDestino[22].Value / orientacionComercialCPIAnioOrigen[22].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato38) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato38) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas24
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[23].Value) || decimalIsZero(orientacionComercialTCAnioDestino[23].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[23].Value / orientacionComercialIPCAnioOrigen[23].Value) * (orientacionComercialTCAnioOrigen[23].Value / orientacionComercialTCAnioDestino[23].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[23].Value)) ? 0 : (orientacionComercialCPIAnioDestino[23].Value / orientacionComercialCPIAnioOrigen[23].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato39) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato39) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas25
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[24].Value) || decimalIsZero(orientacionComercialTCAnioDestino[24].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[24].Value / orientacionComercialIPCAnioOrigen[24].Value) * (orientacionComercialTCAnioOrigen[24].Value / orientacionComercialTCAnioDestino[24].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[24].Value)) ? 0 : (orientacionComercialCPIAnioDestino[24].Value / orientacionComercialCPIAnioOrigen[24].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato40) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato40) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas26
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[25].Value) || decimalIsZero(orientacionComercialTCAnioDestino[25].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[25].Value / orientacionComercialIPCAnioOrigen[25].Value) * (orientacionComercialTCAnioOrigen[25].Value / orientacionComercialTCAnioDestino[25].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[25].Value)) ? 0 : (orientacionComercialCPIAnioDestino[25].Value / orientacionComercialCPIAnioOrigen[25].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato41) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato41) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas27
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[26].Value) || decimalIsZero(orientacionComercialTCAnioDestino[26].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[26].Value / orientacionComercialIPCAnioOrigen[26].Value) * (orientacionComercialTCAnioOrigen[26].Value / orientacionComercialTCAnioDestino[26].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[26].Value)) ? 0 : (orientacionComercialCPIAnioDestino[26].Value / orientacionComercialCPIAnioOrigen[26].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato42) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato42) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas28
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[27].Value) || decimalIsZero(orientacionComercialTCAnioDestino[27].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[27].Value / orientacionComercialIPCAnioOrigen[27].Value) * (orientacionComercialTCAnioOrigen[27].Value / orientacionComercialTCAnioDestino[27].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[27].Value)) ? 0 : (orientacionComercialCPIAnioDestino[27].Value / orientacionComercialCPIAnioOrigen[27].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato43) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato43) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas29
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[28].Value) || decimalIsZero(orientacionComercialTCAnioDestino[28].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[28].Value / orientacionComercialIPCAnioOrigen[28].Value) * (orientacionComercialTCAnioOrigen[28].Value / orientacionComercialTCAnioDestino[28].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[28].Value)) ? 0 : (orientacionComercialCPIAnioDestino[28].Value / orientacionComercialCPIAnioOrigen[28].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato44) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato44) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas30
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[29].Value) || decimalIsZero(orientacionComercialTCAnioDestino[29].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[29].Value / orientacionComercialIPCAnioOrigen[29].Value) * (orientacionComercialTCAnioOrigen[29].Value / orientacionComercialTCAnioDestino[29].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[29].Value)) ? 0 : (orientacionComercialCPIAnioDestino[29].Value / orientacionComercialCPIAnioOrigen[29].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato45) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato45) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas31
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[30].Value) || decimalIsZero(orientacionComercialTCAnioDestino[30].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[30].Value / orientacionComercialIPCAnioOrigen[30].Value) * (orientacionComercialTCAnioOrigen[30].Value / orientacionComercialTCAnioDestino[30].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[30].Value)) ? 0 : (orientacionComercialCPIAnioDestino[30].Value / orientacionComercialCPIAnioOrigen[30].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato46) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato46) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas32
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[31].Value) || decimalIsZero(orientacionComercialTCAnioDestino[31].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[31].Value / orientacionComercialIPCAnioOrigen[31].Value) * (orientacionComercialTCAnioOrigen[31].Value / orientacionComercialTCAnioDestino[31].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[31].Value)) ? 0 : (orientacionComercialCPIAnioDestino[31].Value / orientacionComercialCPIAnioOrigen[31].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato47) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato47) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas33
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[32].Value) || decimalIsZero(orientacionComercialTCAnioDestino[32].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[32].Value / orientacionComercialIPCAnioOrigen[32].Value) * (orientacionComercialTCAnioOrigen[32].Value / orientacionComercialTCAnioDestino[32].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[32].Value)) ? 0 : (orientacionComercialCPIAnioDestino[32].Value / orientacionComercialCPIAnioOrigen[32].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato48) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato48) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas34
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[33].Value) || decimalIsZero(orientacionComercialTCAnioDestino[33].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[33].Value / orientacionComercialIPCAnioOrigen[33].Value) * (orientacionComercialTCAnioOrigen[33].Value / orientacionComercialTCAnioDestino[33].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[33].Value)) ? 0 : (orientacionComercialCPIAnioDestino[33].Value / orientacionComercialCPIAnioOrigen[33].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato49) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato49) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas35
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[34].Value) || decimalIsZero(orientacionComercialTCAnioDestino[34].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[34].Value / orientacionComercialIPCAnioOrigen[34].Value) * (orientacionComercialTCAnioOrigen[34].Value / orientacionComercialTCAnioDestino[34].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[34].Value)) ? 0 : (orientacionComercialCPIAnioDestino[34].Value / orientacionComercialCPIAnioOrigen[34].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato50) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato50) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas36
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[35].Value) || decimalIsZero(orientacionComercialTCAnioDestino[35].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[35].Value / orientacionComercialIPCAnioOrigen[35].Value) * (orientacionComercialTCAnioOrigen[35].Value / orientacionComercialTCAnioDestino[35].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[35].Value)) ? 0 : (orientacionComercialCPIAnioDestino[35].Value / orientacionComercialCPIAnioOrigen[35].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato51) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato51) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas37
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[36].Value) || decimalIsZero(orientacionComercialTCAnioDestino[36].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[36].Value / orientacionComercialIPCAnioOrigen[36].Value) * (orientacionComercialTCAnioOrigen[36].Value / orientacionComercialTCAnioDestino[36].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[36].Value)) ? 0 : (orientacionComercialCPIAnioDestino[36].Value / orientacionComercialCPIAnioOrigen[36].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato52) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato52) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas38
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[37].Value) || decimalIsZero(orientacionComercialTCAnioDestino[37].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[37].Value / orientacionComercialIPCAnioOrigen[37].Value) * (orientacionComercialTCAnioOrigen[37].Value / orientacionComercialTCAnioDestino[37].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[37].Value)) ? 0 : (orientacionComercialCPIAnioDestino[37].Value / orientacionComercialCPIAnioOrigen[37].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato53) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato53) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas39
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[38].Value) || decimalIsZero(orientacionComercialTCAnioDestino[38].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[38].Value / orientacionComercialIPCAnioOrigen[38].Value) * (orientacionComercialTCAnioOrigen[38].Value / orientacionComercialTCAnioDestino[38].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[38].Value)) ? 0 : (orientacionComercialCPIAnioDestino[38].Value / orientacionComercialCPIAnioOrigen[38].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato54) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato54) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas40
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[39].Value) || decimalIsZero(orientacionComercialTCAnioDestino[39].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[39].Value / orientacionComercialIPCAnioOrigen[39].Value) * (orientacionComercialTCAnioOrigen[39].Value / orientacionComercialTCAnioDestino[39].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[39].Value)) ? 0 : (orientacionComercialCPIAnioDestino[39].Value / orientacionComercialCPIAnioOrigen[39].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato55) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato55) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas41
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[40].Value) || decimalIsZero(orientacionComercialTCAnioDestino[40].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[40].Value / orientacionComercialIPCAnioOrigen[40].Value) * (orientacionComercialTCAnioOrigen[40].Value / orientacionComercialTCAnioDestino[40].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[40].Value)) ? 0 : (orientacionComercialCPIAnioDestino[40].Value / orientacionComercialCPIAnioOrigen[40].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato56) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato56) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas42
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[41].Value) || decimalIsZero(orientacionComercialTCAnioDestino[41].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[41].Value / orientacionComercialIPCAnioOrigen[41].Value) * (orientacionComercialTCAnioOrigen[41].Value / orientacionComercialTCAnioDestino[41].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[41].Value)) ? 0 : (orientacionComercialCPIAnioDestino[41].Value / orientacionComercialCPIAnioOrigen[41].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato57) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato57) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas43
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[42].Value) || decimalIsZero(orientacionComercialTCAnioDestino[42].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[42].Value / orientacionComercialIPCAnioOrigen[42].Value) * (orientacionComercialTCAnioOrigen[42].Value / orientacionComercialTCAnioDestino[42].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[42].Value)) ? 0 : (orientacionComercialCPIAnioDestino[42].Value / orientacionComercialCPIAnioOrigen[42].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato58) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato58) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas44
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[43].Value) || decimalIsZero(orientacionComercialTCAnioDestino[43].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[43].Value / orientacionComercialIPCAnioOrigen[43].Value) * (orientacionComercialTCAnioOrigen[43].Value / orientacionComercialTCAnioDestino[43].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[43].Value)) ? 0 : (orientacionComercialCPIAnioDestino[43].Value / orientacionComercialCPIAnioOrigen[43].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato59) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato59) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas45
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[44].Value) || decimalIsZero(orientacionComercialTCAnioDestino[44].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[44].Value / orientacionComercialIPCAnioOrigen[44].Value) * (orientacionComercialTCAnioOrigen[44].Value / orientacionComercialTCAnioDestino[44].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[44].Value)) ? 0 : (orientacionComercialCPIAnioDestino[44].Value / orientacionComercialCPIAnioOrigen[44].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato60) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato60) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas46
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[45].Value) || decimalIsZero(orientacionComercialTCAnioDestino[45].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[45].Value / orientacionComercialIPCAnioOrigen[45].Value) * (orientacionComercialTCAnioOrigen[45].Value / orientacionComercialTCAnioDestino[45].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[45].Value)) ? 0 : (orientacionComercialCPIAnioDestino[45].Value / orientacionComercialCPIAnioOrigen[45].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato61) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato61) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas47
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[46].Value) || decimalIsZero(orientacionComercialTCAnioDestino[46].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[46].Value / orientacionComercialIPCAnioOrigen[46].Value) * (orientacionComercialTCAnioOrigen[46].Value / orientacionComercialTCAnioDestino[46].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[46].Value)) ? 0 : (orientacionComercialCPIAnioDestino[46].Value / orientacionComercialCPIAnioOrigen[46].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato62) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato62) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas48
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[47].Value) || decimalIsZero(orientacionComercialTCAnioDestino[47].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[47].Value / orientacionComercialIPCAnioOrigen[47].Value) * (orientacionComercialTCAnioOrigen[47].Value / orientacionComercialTCAnioDestino[47].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[47].Value)) ? 0 : (orientacionComercialCPIAnioDestino[47].Value / orientacionComercialCPIAnioOrigen[47].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato63) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato63) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas49
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[48].Value) || decimalIsZero(orientacionComercialTCAnioDestino[48].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[48].Value / orientacionComercialIPCAnioOrigen[48].Value) * (orientacionComercialTCAnioOrigen[48].Value / orientacionComercialTCAnioDestino[48].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[48].Value)) ? 0 : (orientacionComercialCPIAnioDestino[48].Value / orientacionComercialCPIAnioOrigen[48].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato64) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato64) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas50
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[49].Value) || decimalIsZero(orientacionComercialTCAnioDestino[49].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[49].Value / orientacionComercialIPCAnioOrigen[49].Value) * (orientacionComercialTCAnioOrigen[49].Value / orientacionComercialTCAnioDestino[49].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[49].Value)) ? 0 : (orientacionComercialCPIAnioDestino[49].Value / orientacionComercialCPIAnioOrigen[49].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato65) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato65) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas51
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[50].Value) || decimalIsZero(orientacionComercialTCAnioDestino[50].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[50].Value / orientacionComercialIPCAnioOrigen[50].Value) * (orientacionComercialTCAnioOrigen[50].Value / orientacionComercialTCAnioDestino[50].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[50].Value)) ? 0 : (orientacionComercialCPIAnioDestino[50].Value / orientacionComercialCPIAnioOrigen[50].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato66) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato66) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas52
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[51].Value) || decimalIsZero(orientacionComercialTCAnioDestino[51].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[51].Value / orientacionComercialIPCAnioOrigen[51].Value) * (orientacionComercialTCAnioOrigen[51].Value / orientacionComercialTCAnioDestino[51].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[51].Value)) ? 0 : (orientacionComercialCPIAnioDestino[51].Value / orientacionComercialCPIAnioOrigen[51].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato67) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato67) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas53
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[52].Value) || decimalIsZero(orientacionComercialTCAnioDestino[52].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[52].Value / orientacionComercialIPCAnioOrigen[52].Value) * (orientacionComercialTCAnioOrigen[52].Value / orientacionComercialTCAnioDestino[52].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[52].Value)) ? 0 : (orientacionComercialCPIAnioDestino[52].Value / orientacionComercialCPIAnioOrigen[52].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato68) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato68) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas54
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[53].Value) || decimalIsZero(orientacionComercialTCAnioDestino[53].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[53].Value / orientacionComercialIPCAnioOrigen[53].Value) * (orientacionComercialTCAnioOrigen[53].Value / orientacionComercialTCAnioDestino[53].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[53].Value)) ? 0 : (orientacionComercialCPIAnioDestino[53].Value / orientacionComercialCPIAnioOrigen[53].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato69) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato69) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas55
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[54].Value) || decimalIsZero(orientacionComercialTCAnioDestino[54].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[54].Value / orientacionComercialIPCAnioOrigen[54].Value) * (orientacionComercialTCAnioOrigen[54].Value / orientacionComercialTCAnioDestino[54].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[54].Value)) ? 0 : (orientacionComercialCPIAnioDestino[54].Value / orientacionComercialCPIAnioOrigen[54].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato70) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato70) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas56
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[55].Value) || decimalIsZero(orientacionComercialTCAnioDestino[55].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[55].Value / orientacionComercialIPCAnioOrigen[55].Value) * (orientacionComercialTCAnioOrigen[55].Value / orientacionComercialTCAnioDestino[55].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[55].Value)) ? 0 : (orientacionComercialCPIAnioDestino[55].Value / orientacionComercialCPIAnioOrigen[55].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato71) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato71) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas57
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[56].Value) || decimalIsZero(orientacionComercialTCAnioDestino[56].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[56].Value / orientacionComercialIPCAnioOrigen[56].Value) * (orientacionComercialTCAnioOrigen[56].Value / orientacionComercialTCAnioDestino[56].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[56].Value)) ? 0 : (orientacionComercialCPIAnioDestino[56].Value / orientacionComercialCPIAnioOrigen[56].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato72) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato72) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas58
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[57].Value) || decimalIsZero(orientacionComercialTCAnioDestino[57].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[57].Value / orientacionComercialIPCAnioOrigen[57].Value) * (orientacionComercialTCAnioOrigen[57].Value / orientacionComercialTCAnioDestino[57].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[57].Value)) ? 0 : (orientacionComercialCPIAnioDestino[57].Value / orientacionComercialCPIAnioOrigen[57].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato73) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato73) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas59
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[58].Value) || decimalIsZero(orientacionComercialTCAnioDestino[58].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[58].Value / orientacionComercialIPCAnioOrigen[58].Value) * (orientacionComercialTCAnioOrigen[58].Value / orientacionComercialTCAnioDestino[58].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[58].Value)) ? 0 : (orientacionComercialCPIAnioDestino[58].Value / orientacionComercialCPIAnioOrigen[58].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato74) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato74) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas60
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[59].Value) || decimalIsZero(orientacionComercialTCAnioDestino[59].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[59].Value / orientacionComercialIPCAnioOrigen[59].Value) * (orientacionComercialTCAnioOrigen[59].Value / orientacionComercialTCAnioDestino[59].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[59].Value)) ? 0 : (orientacionComercialCPIAnioDestino[59].Value / orientacionComercialCPIAnioOrigen[59].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato75) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato75) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas61
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[60].Value) || decimalIsZero(orientacionComercialTCAnioDestino[60].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[60].Value / orientacionComercialIPCAnioOrigen[60].Value) * (orientacionComercialTCAnioOrigen[60].Value / orientacionComercialTCAnioDestino[60].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[60].Value)) ? 0 : (orientacionComercialCPIAnioDestino[60].Value / orientacionComercialCPIAnioOrigen[60].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato76) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato76) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas62
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[61].Value) || decimalIsZero(orientacionComercialTCAnioDestino[61].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[61].Value / orientacionComercialIPCAnioOrigen[61].Value) * (orientacionComercialTCAnioOrigen[61].Value / orientacionComercialTCAnioDestino[61].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[61].Value)) ? 0 : (orientacionComercialCPIAnioDestino[61].Value / orientacionComercialCPIAnioOrigen[61].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato77) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato77) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas63
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[62].Value) || decimalIsZero(orientacionComercialTCAnioDestino[62].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[62].Value / orientacionComercialIPCAnioOrigen[62].Value) * (orientacionComercialTCAnioOrigen[62].Value / orientacionComercialTCAnioDestino[62].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[62].Value)) ? 0 : (orientacionComercialCPIAnioDestino[62].Value / orientacionComercialCPIAnioOrigen[62].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato78) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato78) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas64
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[63].Value) || decimalIsZero(orientacionComercialTCAnioDestino[63].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[63].Value / orientacionComercialIPCAnioOrigen[63].Value) * (orientacionComercialTCAnioOrigen[63].Value / orientacionComercialTCAnioDestino[63].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[63].Value)) ? 0 : (orientacionComercialCPIAnioDestino[63].Value / orientacionComercialCPIAnioOrigen[63].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato79) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato79) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas65
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[64].Value) || decimalIsZero(orientacionComercialTCAnioDestino[64].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[64].Value / orientacionComercialIPCAnioOrigen[64].Value) * (orientacionComercialTCAnioOrigen[64].Value / orientacionComercialTCAnioDestino[64].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[64].Value)) ? 0 : (orientacionComercialCPIAnioDestino[64].Value / orientacionComercialCPIAnioOrigen[64].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato80) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato80) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas66
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[65].Value) || decimalIsZero(orientacionComercialTCAnioDestino[65].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[65].Value / orientacionComercialIPCAnioOrigen[65].Value) * (orientacionComercialTCAnioOrigen[65].Value / orientacionComercialTCAnioDestino[65].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[65].Value)) ? 0 : (orientacionComercialCPIAnioDestino[65].Value / orientacionComercialCPIAnioOrigen[65].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato81) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato81) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas67
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[66].Value) || decimalIsZero(orientacionComercialTCAnioDestino[66].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[66].Value / orientacionComercialIPCAnioOrigen[66].Value) * (orientacionComercialTCAnioOrigen[66].Value / orientacionComercialTCAnioDestino[66].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[66].Value)) ? 0 : (orientacionComercialCPIAnioDestino[66].Value / orientacionComercialCPIAnioOrigen[66].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato82) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato82) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas68
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[67].Value) || decimalIsZero(orientacionComercialTCAnioDestino[67].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[67].Value / orientacionComercialIPCAnioOrigen[67].Value) * (orientacionComercialTCAnioOrigen[67].Value / orientacionComercialTCAnioDestino[67].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[67].Value)) ? 0 : (orientacionComercialCPIAnioDestino[67].Value / orientacionComercialCPIAnioOrigen[67].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato83) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato83) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas69
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[68].Value) || decimalIsZero(orientacionComercialTCAnioDestino[68].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[68].Value / orientacionComercialIPCAnioOrigen[68].Value) * (orientacionComercialTCAnioOrigen[68].Value / orientacionComercialTCAnioDestino[68].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[68].Value)) ? 0 : (orientacionComercialCPIAnioDestino[68].Value / orientacionComercialCPIAnioOrigen[68].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato84) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato84) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas70
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[69].Value) || decimalIsZero(orientacionComercialTCAnioDestino[69].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[69].Value / orientacionComercialIPCAnioOrigen[69].Value) * (orientacionComercialTCAnioOrigen[69].Value / orientacionComercialTCAnioDestino[69].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[69].Value)) ? 0 : (orientacionComercialCPIAnioDestino[69].Value / orientacionComercialCPIAnioOrigen[69].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato85) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato85) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas71
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[70].Value) || decimalIsZero(orientacionComercialTCAnioDestino[70].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[70].Value / orientacionComercialIPCAnioOrigen[70].Value) * (orientacionComercialTCAnioOrigen[70].Value / orientacionComercialTCAnioDestino[70].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[70].Value)) ? 0 : (orientacionComercialCPIAnioDestino[70].Value / orientacionComercialCPIAnioOrigen[70].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato86) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato86) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas72
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[71].Value) || decimalIsZero(orientacionComercialTCAnioDestino[71].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[71].Value / orientacionComercialIPCAnioOrigen[71].Value) * (orientacionComercialTCAnioOrigen[71].Value / orientacionComercialTCAnioDestino[71].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[71].Value)) ? 0 : (orientacionComercialCPIAnioDestino[71].Value / orientacionComercialCPIAnioOrigen[71].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato87) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato87) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas73
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[72].Value) || decimalIsZero(orientacionComercialTCAnioDestino[72].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[72].Value / orientacionComercialIPCAnioOrigen[72].Value) * (orientacionComercialTCAnioOrigen[72].Value / orientacionComercialTCAnioDestino[72].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[72].Value)) ? 0 : (orientacionComercialCPIAnioDestino[72].Value / orientacionComercialCPIAnioOrigen[72].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato88) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato88) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas74
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[73].Value) || decimalIsZero(orientacionComercialTCAnioDestino[73].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[73].Value / orientacionComercialIPCAnioOrigen[73].Value) * (orientacionComercialTCAnioOrigen[73].Value / orientacionComercialTCAnioDestino[73].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[73].Value)) ? 0 : (orientacionComercialCPIAnioDestino[73].Value / orientacionComercialCPIAnioOrigen[73].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato89) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato89) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas75
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[74].Value) || decimalIsZero(orientacionComercialTCAnioDestino[74].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[74].Value / orientacionComercialIPCAnioOrigen[74].Value) * (orientacionComercialTCAnioOrigen[74].Value / orientacionComercialTCAnioDestino[74].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[74].Value)) ? 0 : (orientacionComercialCPIAnioDestino[74].Value / orientacionComercialCPIAnioOrigen[74].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato90) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato90) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas76
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[75].Value) || decimalIsZero(orientacionComercialTCAnioDestino[75].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[75].Value / orientacionComercialIPCAnioOrigen[75].Value) * (orientacionComercialTCAnioOrigen[75].Value / orientacionComercialTCAnioDestino[75].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[75].Value)) ? 0 : (orientacionComercialCPIAnioDestino[75].Value / orientacionComercialCPIAnioOrigen[75].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato91) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato91) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas77
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[76].Value) || decimalIsZero(orientacionComercialTCAnioDestino[76].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[76].Value / orientacionComercialIPCAnioOrigen[76].Value) * (orientacionComercialTCAnioOrigen[76].Value / orientacionComercialTCAnioDestino[76].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[76].Value)) ? 0 : (orientacionComercialCPIAnioDestino[76].Value / orientacionComercialCPIAnioOrigen[76].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato92) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato92) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas78
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[77].Value) || decimalIsZero(orientacionComercialTCAnioDestino[77].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[77].Value / orientacionComercialIPCAnioOrigen[77].Value) * (orientacionComercialTCAnioOrigen[77].Value / orientacionComercialTCAnioDestino[77].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[77].Value)) ? 0 : (orientacionComercialCPIAnioDestino[77].Value / orientacionComercialCPIAnioOrigen[77].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato93) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato93) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas79
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[78].Value) || decimalIsZero(orientacionComercialTCAnioDestino[78].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[78].Value / orientacionComercialIPCAnioOrigen[78].Value) * (orientacionComercialTCAnioOrigen[78].Value / orientacionComercialTCAnioDestino[78].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[78].Value)) ? 0 : (orientacionComercialCPIAnioDestino[78].Value / orientacionComercialCPIAnioOrigen[78].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato94) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato94) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas80
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[79].Value) || decimalIsZero(orientacionComercialTCAnioDestino[79].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[79].Value / orientacionComercialIPCAnioOrigen[79].Value) * (orientacionComercialTCAnioOrigen[79].Value / orientacionComercialTCAnioDestino[79].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[79].Value)) ? 0 : (orientacionComercialCPIAnioDestino[79].Value / orientacionComercialCPIAnioOrigen[79].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato95) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato95) * facCorrMonExt, ValorTotal = 0 });
                                                            //Total por año
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                        ...
                                                        {
                                                            consMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDato0.ToString() });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato2);
                                                            ...
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            InsertarTraceLog(iniToken, "facCorrMonNac=" + facCorrMonNac + ",facCorrMonNac=" + facCorrMonNac + ", filaMonedaNacional.IfDato5=" + filaMonedaNacional.IfDato5 + ", stringNumberFormatFromDB(filaMonedaNacional.IfDato5)=" + stringNumberFormatFromDB(filaMonedaNacional.IfDato5) + ", stringToDecimal(filaMonedaNacional.IfDato5)=" + stringToDecimalFromDB(filaMonedaNacional.IfDato5), usuario);
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            //Octubre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            //Noviembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[3].Value) || decimalIsZero(orientacionComercialTCAnioDestino[3].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[3].Value / orientacionComercialIPCAnioOrigen[3].Value) * (orientacionComercialTCAnioOrigen[3].Value / orientacionComercialTCAnioDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[3].Value)) ? 0 : (orientacionComercialCPIAnioDestino[3].Value / orientacionComercialCPIAnioOrigen[3].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato19) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato19) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[4].Value) || decimalIsZero(orientacionComercialTCAnioDestino[4].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[4].Value / orientacionComercialIPCAnioOrigen[4].Value) * (orientacionComercialTCAnioOrigen[4].Value / orientacionComercialTCAnioDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[4].Value)) ? 0 : (orientacionComercialCPIAnioDestino[4].Value / orientacionComercialCPIAnioOrigen[4].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato20) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato20) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[5].Value) || decimalIsZero(orientacionComercialTCAnioDestino[5].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[5].Value / orientacionComercialIPCAnioOrigen[5].Value) * (orientacionComercialTCAnioOrigen[5].Value / orientacionComercialTCAnioDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[5].Value)) ? 0 : (orientacionComercialCPIAnioDestino[5].Value / orientacionComercialCPIAnioOrigen[5].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato21) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato21) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[6].Value) || decimalIsZero(orientacionComercialTCAnioDestino[6].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[6].Value / orientacionComercialIPCAnioOrigen[6].Value) * (orientacionComercialTCAnioOrigen[6].Value / orientacionComercialTCAnioDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[6].Value)) ? 0 : (orientacionComercialCPIAnioDestino[6].Value / orientacionComercialCPIAnioOrigen[6].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato22) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato22) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[7].Value) || decimalIsZero(orientacionComercialTCAnioDestino[7].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[7].Value / orientacionComercialIPCAnioOrigen[7].Value) * (orientacionComercialTCAnioOrigen[7].Value / orientacionComercialTCAnioDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[7].Value)) ? 0 : (orientacionComercialCPIAnioDestino[7].Value / orientacionComercialCPIAnioOrigen[7].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato23) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato23) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[8].Value) || decimalIsZero(orientacionComercialTCAnioDestino[8].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[8].Value / orientacionComercialIPCAnioOrigen[8].Value) * (orientacionComercialTCAnioOrigen[8].Value / orientacionComercialTCAnioDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[8].Value)) ? 0 : (orientacionComercialCPIAnioDestino[8].Value / orientacionComercialCPIAnioOrigen[8].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato24) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato24) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[9].Value) || decimalIsZero(orientacionComercialTCAnioDestino[9].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[9].Value / orientacionComercialIPCAnioOrigen[9].Value) * (orientacionComercialTCAnioOrigen[9].Value / orientacionComercialTCAnioDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[9].Value)) ? 0 : (orientacionComercialCPIAnioDestino[9].Value / orientacionComercialCPIAnioOrigen[9].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato25) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato25) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[10].Value) || decimalIsZero(orientacionComercialTCAnioDestino[10].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[10].Value / orientacionComercialIPCAnioOrigen[10].Value) * (orientacionComercialTCAnioOrigen[10].Value / orientacionComercialTCAnioDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[10].Value)) ? 0 : (orientacionComercialCPIAnioDestino[10].Value / orientacionComercialCPIAnioOrigen[10].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato26) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato26) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[11].Value) || decimalIsZero(orientacionComercialTCAnioDestino[11].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[11].Value / orientacionComercialIPCAnioOrigen[11].Value) * (orientacionComercialTCAnioOrigen[11].Value / orientacionComercialTCAnioDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[11].Value)) ? 0 : (orientacionComercialCPIAnioDestino[11].Value / orientacionComercialCPIAnioOrigen[11].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato27) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato27) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[12].Value) || decimalIsZero(orientacionComercialTCAnioDestino[12].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[12].Value / orientacionComercialIPCAnioOrigen[12].Value) * (orientacionComercialTCAnioOrigen[12].Value / orientacionComercialTCAnioDestino[12].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[12].Value)) ? 0 : (orientacionComercialCPIAnioDestino[12].Value / orientacionComercialCPIAnioOrigen[12].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato28) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato28) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[13].Value) || decimalIsZero(orientacionComercialTCAnioDestino[13].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[13].Value / orientacionComercialIPCAnioOrigen[13].Value) * (orientacionComercialTCAnioOrigen[13].Value / orientacionComercialTCAnioDestino[13].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[13].Value)) ? 0 : (orientacionComercialCPIAnioDestino[13].Value / orientacionComercialCPIAnioOrigen[13].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato29) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato29) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[14].Value) || decimalIsZero(orientacionComercialTCAnioDestino[14].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[14].Value / orientacionComercialIPCAnioOrigen[14].Value) * (orientacionComercialTCAnioOrigen[14].Value / orientacionComercialTCAnioDestino[14].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[14].Value)) ? 0 : (orientacionComercialCPIAnioDestino[14].Value / orientacionComercialCPIAnioOrigen[14].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato30) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato30) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[15].Value) || decimalIsZero(orientacionComercialTCAnioDestino[15].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[15].Value / orientacionComercialIPCAnioOrigen[15].Value) * (orientacionComercialTCAnioOrigen[15].Value / orientacionComercialTCAnioDestino[15].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[15].Value)) ? 0 : (orientacionComercialCPIAnioDestino[15].Value / orientacionComercialCPIAnioOrigen[15].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato31) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato31) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[16].Value) || decimalIsZero(orientacionComercialTCAnioDestino[16].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[16].Value / orientacionComercialIPCAnioOrigen[16].Value) * (orientacionComercialTCAnioOrigen[16].Value / orientacionComercialTCAnioDestino[16].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[16].Value)) ? 0 : (orientacionComercialCPIAnioDestino[16].Value / orientacionComercialCPIAnioOrigen[16].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato32) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato32) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[17].Value) || decimalIsZero(orientacionComercialTCAnioDestino[17].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[17].Value / orientacionComercialIPCAnioOrigen[17].Value) * (orientacionComercialTCAnioOrigen[17].Value / orientacionComercialTCAnioDestino[17].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[17].Value)) ? 0 : (orientacionComercialCPIAnioDestino[17].Value / orientacionComercialCPIAnioOrigen[17].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato33) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato33) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[18].Value) || decimalIsZero(orientacionComercialTCAnioDestino[18].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[18].Value / orientacionComercialIPCAnioOrigen[18].Value) * (orientacionComercialTCAnioOrigen[18].Value / orientacionComercialTCAnioDestino[18].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[18].Value)) ? 0 : (orientacionComercialCPIAnioDestino[18].Value / orientacionComercialCPIAnioOrigen[18].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato34) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato34) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[19].Value) || decimalIsZero(orientacionComercialTCAnioDestino[19].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[19].Value / orientacionComercialIPCAnioOrigen[19].Value) * (orientacionComercialTCAnioOrigen[19].Value / orientacionComercialTCAnioDestino[19].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[19].Value)) ? 0 : (orientacionComercialCPIAnioDestino[19].Value / orientacionComercialCPIAnioOrigen[19].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato35) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato35) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[20].Value) || decimalIsZero(orientacionComercialTCAnioDestino[20].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[20].Value / orientacionComercialIPCAnioOrigen[20].Value) * (orientacionComercialTCAnioOrigen[20].Value / orientacionComercialTCAnioDestino[20].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[20].Value)) ? 0 : (orientacionComercialCPIAnioDestino[20].Value / orientacionComercialCPIAnioOrigen[20].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato36) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato36) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[21].Value) || decimalIsZero(orientacionComercialTCAnioDestino[21].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[21].Value / orientacionComercialIPCAnioOrigen[21].Value) * (orientacionComercialTCAnioOrigen[21].Value / orientacionComercialTCAnioDestino[21].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[21].Value)) ? 0 : (orientacionComercialCPIAnioDestino[21].Value / orientacionComercialCPIAnioOrigen[21].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato37) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato37) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[22].Value) || decimalIsZero(orientacionComercialTCAnioDestino[22].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[22].Value / orientacionComercialIPCAnioOrigen[22].Value) * (orientacionComercialTCAnioOrigen[22].Value / orientacionComercialTCAnioDestino[22].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[22].Value)) ? 0 : (orientacionComercialCPIAnioDestino[22].Value / orientacionComercialCPIAnioOrigen[22].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato38) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato38) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[23].Value) || decimalIsZero(orientacionComercialTCAnioDestino[23].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[23].Value / orientacionComercialIPCAnioOrigen[23].Value) * (orientacionComercialTCAnioOrigen[23].Value / orientacionComercialTCAnioDestino[23].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[23].Value)) ? 0 : (orientacionComercialCPIAnioDestino[23].Value / orientacionComercialCPIAnioOrigen[23].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato39) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato39) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[24].Value) || decimalIsZero(orientacionComercialTCAnioDestino[24].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[24].Value / orientacionComercialIPCAnioOrigen[24].Value) * (orientacionComercialTCAnioOrigen[24].Value / orientacionComercialTCAnioDestino[24].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[24].Value)) ? 0 : (orientacionComercialCPIAnioDestino[24].Value / orientacionComercialCPIAnioOrigen[24].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato40) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato40) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[25].Value) || decimalIsZero(orientacionComercialTCAnioDestino[25].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[25].Value / orientacionComercialIPCAnioOrigen[25].Value) * (orientacionComercialTCAnioOrigen[25].Value / orientacionComercialTCAnioDestino[25].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[25].Value)) ? 0 : (orientacionComercialCPIAnioDestino[25].Value / orientacionComercialCPIAnioOrigen[25].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato41) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato41) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[26].Value) || decimalIsZero(orientacionComercialTCAnioDestino[26].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[26].Value / orientacionComercialIPCAnioOrigen[26].Value) * (orientacionComercialTCAnioOrigen[26].Value / orientacionComercialTCAnioDestino[26].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[26].Value)) ? 0 : (orientacionComercialCPIAnioDestino[26].Value / orientacionComercialCPIAnioOrigen[26].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato42) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato42) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[27].Value) || decimalIsZero(orientacionComercialTCAnioDestino[27].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[27].Value / orientacionComercialIPCAnioOrigen[27].Value) * (orientacionComercialTCAnioOrigen[27].Value / orientacionComercialTCAnioDestino[27].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[27].Value)) ? 0 : (orientacionComercialCPIAnioDestino[27].Value / orientacionComercialCPIAnioOrigen[27].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato43) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato43) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[28].Value) || decimalIsZero(orientacionComercialTCAnioDestino[28].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[28].Value / orientacionComercialIPCAnioOrigen[28].Value) * (orientacionComercialTCAnioOrigen[28].Value / orientacionComercialTCAnioDestino[28].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[28].Value)) ? 0 : (orientacionComercialCPIAnioDestino[28].Value / orientacionComercialCPIAnioOrigen[28].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato44) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato44) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[29].Value) || decimalIsZero(orientacionComercialTCAnioDestino[29].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[29].Value / orientacionComercialIPCAnioOrigen[29].Value) * (orientacionComercialTCAnioOrigen[29].Value / orientacionComercialTCAnioDestino[29].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[29].Value)) ? 0 : (orientacionComercialCPIAnioDestino[29].Value / orientacionComercialCPIAnioOrigen[29].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato45) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato45) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[30].Value) || decimalIsZero(orientacionComercialTCAnioDestino[30].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[30].Value / orientacionComercialIPCAnioOrigen[30].Value) * (orientacionComercialTCAnioOrigen[30].Value / orientacionComercialTCAnioDestino[30].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[30].Value)) ? 0 : (orientacionComercialCPIAnioDestino[30].Value / orientacionComercialCPIAnioOrigen[30].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato46) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato46) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[31].Value) || decimalIsZero(orientacionComercialTCAnioDestino[31].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[31].Value / orientacionComercialIPCAnioOrigen[31].Value) * (orientacionComercialTCAnioOrigen[31].Value / orientacionComercialTCAnioDestino[31].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[31].Value)) ? 0 : (orientacionComercialCPIAnioDestino[31].Value / orientacionComercialCPIAnioOrigen[31].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato47) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato47) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[32].Value) || decimalIsZero(orientacionComercialTCAnioDestino[32].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[32].Value / orientacionComercialIPCAnioOrigen[32].Value) * (orientacionComercialTCAnioOrigen[32].Value / orientacionComercialTCAnioDestino[32].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[32].Value)) ? 0 : (orientacionComercialCPIAnioDestino[32].Value / orientacionComercialCPIAnioOrigen[32].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato48) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato48) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[33].Value) || decimalIsZero(orientacionComercialTCAnioDestino[33].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[33].Value / orientacionComercialIPCAnioOrigen[33].Value) * (orientacionComercialTCAnioOrigen[33].Value / orientacionComercialTCAnioDestino[33].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[33].Value)) ? 0 : (orientacionComercialCPIAnioDestino[33].Value / orientacionComercialCPIAnioOrigen[33].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato49) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato49) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[34].Value) || decimalIsZero(orientacionComercialTCAnioDestino[34].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[34].Value / orientacionComercialIPCAnioOrigen[34].Value) * (orientacionComercialTCAnioOrigen[34].Value / orientacionComercialTCAnioDestino[34].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[34].Value)) ? 0 : (orientacionComercialCPIAnioDestino[34].Value / orientacionComercialCPIAnioOrigen[34].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato50) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato50) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[35].Value) || decimalIsZero(orientacionComercialTCAnioDestino[35].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[35].Value / orientacionComercialIPCAnioOrigen[35].Value) * (orientacionComercialTCAnioOrigen[35].Value / orientacionComercialTCAnioDestino[35].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[35].Value)) ? 0 : (orientacionComercialCPIAnioDestino[35].Value / orientacionComercialCPIAnioOrigen[35].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato51) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato51) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[36].Value) || decimalIsZero(orientacionComercialTCAnioDestino[36].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[36].Value / orientacionComercialIPCAnioOrigen[36].Value) * (orientacionComercialTCAnioOrigen[36].Value / orientacionComercialTCAnioDestino[36].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[36].Value)) ? 0 : (orientacionComercialCPIAnioDestino[36].Value / orientacionComercialCPIAnioOrigen[36].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato52) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato52) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[37].Value) || decimalIsZero(orientacionComercialTCAnioDestino[37].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[37].Value / orientacionComercialIPCAnioOrigen[37].Value) * (orientacionComercialTCAnioOrigen[37].Value / orientacionComercialTCAnioDestino[37].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[37].Value)) ? 0 : (orientacionComercialCPIAnioDestino[37].Value / orientacionComercialCPIAnioOrigen[37].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato53) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato53) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[38].Value) || decimalIsZero(orientacionComercialTCAnioDestino[38].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[38].Value / orientacionComercialIPCAnioOrigen[38].Value) * (orientacionComercialTCAnioOrigen[38].Value / orientacionComercialTCAnioDestino[38].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[38].Value)) ? 0 : (orientacionComercialCPIAnioDestino[38].Value / orientacionComercialCPIAnioOrigen[38].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato54) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato54) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[39].Value) || decimalIsZero(orientacionComercialTCAnioDestino[39].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[39].Value / orientacionComercialIPCAnioOrigen[39].Value) * (orientacionComercialTCAnioOrigen[39].Value / orientacionComercialTCAnioDestino[39].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[39].Value)) ? 0 : (orientacionComercialCPIAnioDestino[39].Value / orientacionComercialCPIAnioOrigen[39].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato55) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato55) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[40].Value) || decimalIsZero(orientacionComercialTCAnioDestino[40].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[40].Value / orientacionComercialIPCAnioOrigen[40].Value) * (orientacionComercialTCAnioOrigen[40].Value / orientacionComercialTCAnioDestino[40].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[40].Value)) ? 0 : (orientacionComercialCPIAnioDestino[40].Value / orientacionComercialCPIAnioOrigen[40].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato56) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato56) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[41].Value) || decimalIsZero(orientacionComercialTCAnioDestino[41].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[41].Value / orientacionComercialIPCAnioOrigen[41].Value) * (orientacionComercialTCAnioOrigen[41].Value / orientacionComercialTCAnioDestino[41].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[41].Value)) ? 0 : (orientacionComercialCPIAnioDestino[41].Value / orientacionComercialCPIAnioOrigen[41].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato57) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato57) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[42].Value) || decimalIsZero(orientacionComercialTCAnioDestino[42].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[42].Value / orientacionComercialIPCAnioOrigen[42].Value) * (orientacionComercialTCAnioOrigen[42].Value / orientacionComercialTCAnioDestino[42].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[42].Value)) ? 0 : (orientacionComercialCPIAnioDestino[42].Value / orientacionComercialCPIAnioOrigen[42].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato58) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato58) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[43].Value) || decimalIsZero(orientacionComercialTCAnioDestino[43].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[43].Value / orientacionComercialIPCAnioOrigen[43].Value) * (orientacionComercialTCAnioOrigen[43].Value / orientacionComercialTCAnioDestino[43].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[43].Value)) ? 0 : (orientacionComercialCPIAnioDestino[43].Value / orientacionComercialCPIAnioOrigen[43].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato59) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato59) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[44].Value) || decimalIsZero(orientacionComercialTCAnioDestino[44].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[44].Value / orientacionComercialIPCAnioOrigen[44].Value) * (orientacionComercialTCAnioOrigen[44].Value / orientacionComercialTCAnioDestino[44].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[44].Value)) ? 0 : (orientacionComercialCPIAnioDestino[44].Value / orientacionComercialCPIAnioOrigen[44].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato60) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato60) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[45].Value) || decimalIsZero(orientacionComercialTCAnioDestino[45].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[45].Value / orientacionComercialIPCAnioOrigen[45].Value) * (orientacionComercialTCAnioOrigen[45].Value / orientacionComercialTCAnioDestino[45].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[45].Value)) ? 0 : (orientacionComercialCPIAnioDestino[45].Value / orientacionComercialCPIAnioOrigen[45].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato61) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato61) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[46].Value) || decimalIsZero(orientacionComercialTCAnioDestino[46].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[46].Value / orientacionComercialIPCAnioOrigen[46].Value) * (orientacionComercialTCAnioOrigen[46].Value / orientacionComercialTCAnioDestino[46].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[46].Value)) ? 0 : (orientacionComercialCPIAnioDestino[46].Value / orientacionComercialCPIAnioOrigen[46].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato62) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato62) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[47].Value) || decimalIsZero(orientacionComercialTCAnioDestino[47].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[47].Value / orientacionComercialIPCAnioOrigen[47].Value) * (orientacionComercialTCAnioOrigen[47].Value / orientacionComercialTCAnioDestino[47].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[47].Value)) ? 0 : (orientacionComercialCPIAnioDestino[47].Value / orientacionComercialCPIAnioOrigen[47].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato63) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato63) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[48].Value) || decimalIsZero(orientacionComercialTCAnioDestino[48].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[48].Value / orientacionComercialIPCAnioOrigen[48].Value) * (orientacionComercialTCAnioOrigen[48].Value / orientacionComercialTCAnioDestino[48].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[48].Value)) ? 0 : (orientacionComercialCPIAnioDestino[48].Value / orientacionComercialCPIAnioOrigen[48].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato64) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato64) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[49].Value) || decimalIsZero(orientacionComercialTCAnioDestino[49].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[49].Value / orientacionComercialIPCAnioOrigen[49].Value) * (orientacionComercialTCAnioOrigen[49].Value / orientacionComercialTCAnioDestino[49].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[49].Value)) ? 0 : (orientacionComercialCPIAnioDestino[49].Value / orientacionComercialCPIAnioOrigen[49].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato65) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato65) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[50].Value) || decimalIsZero(orientacionComercialTCAnioDestino[50].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[50].Value / orientacionComercialIPCAnioOrigen[50].Value) * (orientacionComercialTCAnioOrigen[50].Value / orientacionComercialTCAnioDestino[50].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[50].Value)) ? 0 : (orientacionComercialCPIAnioDestino[50].Value / orientacionComercialCPIAnioOrigen[50].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato66) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato66) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[51].Value) || decimalIsZero(orientacionComercialTCAnioDestino[51].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[51].Value / orientacionComercialIPCAnioOrigen[51].Value) * (orientacionComercialTCAnioOrigen[51].Value / orientacionComercialTCAnioDestino[51].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[51].Value)) ? 0 : (orientacionComercialCPIAnioDestino[51].Value / orientacionComercialCPIAnioOrigen[51].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato67) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato67) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[52].Value) || decimalIsZero(orientacionComercialTCAnioDestino[52].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[52].Value / orientacionComercialIPCAnioOrigen[52].Value) * (orientacionComercialTCAnioOrigen[52].Value / orientacionComercialTCAnioDestino[52].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[52].Value)) ? 0 : (orientacionComercialCPIAnioDestino[52].Value / orientacionComercialCPIAnioOrigen[52].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato68) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato68) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[53].Value) || decimalIsZero(orientacionComercialTCAnioDestino[53].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[53].Value / orientacionComercialIPCAnioOrigen[53].Value) * (orientacionComercialTCAnioOrigen[53].Value / orientacionComercialTCAnioDestino[53].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[53].Value)) ? 0 : (orientacionComercialCPIAnioDestino[53].Value / orientacionComercialCPIAnioOrigen[53].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato69) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato69) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[54].Value) || decimalIsZero(orientacionComercialTCAnioDestino[54].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[54].Value / orientacionComercialIPCAnioOrigen[54].Value) * (orientacionComercialTCAnioOrigen[54].Value / orientacionComercialTCAnioDestino[54].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[54].Value)) ? 0 : (orientacionComercialCPIAnioDestino[54].Value / orientacionComercialCPIAnioOrigen[54].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato70) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato70) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[55].Value) || decimalIsZero(orientacionComercialTCAnioDestino[55].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[55].Value / orientacionComercialIPCAnioOrigen[55].Value) * (orientacionComercialTCAnioOrigen[55].Value / orientacionComercialTCAnioDestino[55].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[55].Value)) ? 0 : (orientacionComercialCPIAnioDestino[55].Value / orientacionComercialCPIAnioOrigen[55].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato71) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato71) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[56].Value) || decimalIsZero(orientacionComercialTCAnioDestino[56].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[56].Value / orientacionComercialIPCAnioOrigen[56].Value) * (orientacionComercialTCAnioOrigen[56].Value / orientacionComercialTCAnioDestino[56].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[56].Value)) ? 0 : (orientacionComercialCPIAnioDestino[56].Value / orientacionComercialCPIAnioOrigen[56].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato72) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato72) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[57].Value) || decimalIsZero(orientacionComercialTCAnioDestino[57].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[57].Value / orientacionComercialIPCAnioOrigen[57].Value) * (orientacionComercialTCAnioOrigen[57].Value / orientacionComercialTCAnioDestino[57].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[57].Value)) ? 0 : (orientacionComercialCPIAnioDestino[57].Value / orientacionComercialCPIAnioOrigen[57].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato73) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato73) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[58].Value) || decimalIsZero(orientacionComercialTCAnioDestino[58].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[58].Value / orientacionComercialIPCAnioOrigen[58].Value) * (orientacionComercialTCAnioOrigen[58].Value / orientacionComercialTCAnioDestino[58].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[58].Value)) ? 0 : (orientacionComercialCPIAnioDestino[58].Value / orientacionComercialCPIAnioOrigen[58].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato74) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato74) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[59].Value) || decimalIsZero(orientacionComercialTCAnioDestino[59].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[59].Value / orientacionComercialIPCAnioOrigen[59].Value) * (orientacionComercialTCAnioOrigen[59].Value / orientacionComercialTCAnioDestino[59].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[59].Value)) ? 0 : (orientacionComercialCPIAnioDestino[59].Value / orientacionComercialCPIAnioOrigen[59].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato75) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato75) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[60].Value) || decimalIsZero(orientacionComercialTCAnioDestino[60].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[60].Value / orientacionComercialIPCAnioOrigen[60].Value) * (orientacionComercialTCAnioOrigen[60].Value / orientacionComercialTCAnioDestino[60].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[60].Value)) ? 0 : (orientacionComercialCPIAnioDestino[60].Value / orientacionComercialCPIAnioOrigen[60].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato76) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato76) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[61].Value) || decimalIsZero(orientacionComercialTCAnioDestino[61].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[61].Value / orientacionComercialIPCAnioOrigen[61].Value) * (orientacionComercialTCAnioOrigen[61].Value / orientacionComercialTCAnioDestino[61].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[61].Value)) ? 0 : (orientacionComercialCPIAnioDestino[61].Value / orientacionComercialCPIAnioOrigen[61].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato77) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato77) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[62].Value) || decimalIsZero(orientacionComercialTCAnioDestino[62].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[62].Value / orientacionComercialIPCAnioOrigen[62].Value) * (orientacionComercialTCAnioOrigen[62].Value / orientacionComercialTCAnioDestino[62].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[62].Value)) ? 0 : (orientacionComercialCPIAnioDestino[62].Value / orientacionComercialCPIAnioOrigen[62].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato78) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato78) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[63].Value) || decimalIsZero(orientacionComercialTCAnioDestino[63].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[63].Value / orientacionComercialIPCAnioOrigen[63].Value) * (orientacionComercialTCAnioOrigen[63].Value / orientacionComercialTCAnioDestino[63].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[63].Value)) ? 0 : (orientacionComercialCPIAnioDestino[63].Value / orientacionComercialCPIAnioOrigen[63].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato79) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato79) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[64].Value) || decimalIsZero(orientacionComercialTCAnioDestino[64].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[64].Value / orientacionComercialIPCAnioOrigen[64].Value) * (orientacionComercialTCAnioOrigen[64].Value / orientacionComercialTCAnioDestino[64].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[64].Value)) ? 0 : (orientacionComercialCPIAnioDestino[64].Value / orientacionComercialCPIAnioOrigen[64].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato80) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato80) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[65].Value) || decimalIsZero(orientacionComercialTCAnioDestino[65].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[65].Value / orientacionComercialIPCAnioOrigen[65].Value) * (orientacionComercialTCAnioOrigen[65].Value / orientacionComercialTCAnioDestino[65].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[65].Value)) ? 0 : (orientacionComercialCPIAnioDestino[65].Value / orientacionComercialCPIAnioOrigen[65].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato81) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato81) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[66].Value) || decimalIsZero(orientacionComercialTCAnioDestino[66].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[66].Value / orientacionComercialIPCAnioOrigen[66].Value) * (orientacionComercialTCAnioOrigen[66].Value / orientacionComercialTCAnioDestino[66].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[66].Value)) ? 0 : (orientacionComercialCPIAnioDestino[66].Value / orientacionComercialCPIAnioOrigen[66].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato82) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato82) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[67].Value) || decimalIsZero(orientacionComercialTCAnioDestino[67].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[67].Value / orientacionComercialIPCAnioOrigen[67].Value) * (orientacionComercialTCAnioOrigen[67].Value / orientacionComercialTCAnioDestino[67].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[67].Value)) ? 0 : (orientacionComercialCPIAnioDestino[67].Value / orientacionComercialCPIAnioOrigen[67].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato83) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato83) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[68].Value) || decimalIsZero(orientacionComercialTCAnioDestino[68].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[68].Value / orientacionComercialIPCAnioOrigen[68].Value) * (orientacionComercialTCAnioOrigen[68].Value / orientacionComercialTCAnioDestino[68].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[68].Value)) ? 0 : (orientacionComercialCPIAnioDestino[68].Value / orientacionComercialCPIAnioOrigen[68].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato84) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato84) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[69].Value) || decimalIsZero(orientacionComercialTCAnioDestino[69].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[69].Value / orientacionComercialIPCAnioOrigen[69].Value) * (orientacionComercialTCAnioOrigen[69].Value / orientacionComercialTCAnioDestino[69].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[69].Value)) ? 0 : (orientacionComercialCPIAnioDestino[69].Value / orientacionComercialCPIAnioOrigen[69].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato85) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato85) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[70].Value) || decimalIsZero(orientacionComercialTCAnioDestino[70].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[70].Value / orientacionComercialIPCAnioOrigen[70].Value) * (orientacionComercialTCAnioOrigen[70].Value / orientacionComercialTCAnioDestino[70].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[70].Value)) ? 0 : (orientacionComercialCPIAnioDestino[70].Value / orientacionComercialCPIAnioOrigen[70].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato86) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato86) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[71].Value) || decimalIsZero(orientacionComercialTCAnioDestino[71].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[71].Value / orientacionComercialIPCAnioOrigen[71].Value) * (orientacionComercialTCAnioOrigen[71].Value / orientacionComercialTCAnioDestino[71].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[71].Value)) ? 0 : (orientacionComercialCPIAnioDestino[71].Value / orientacionComercialCPIAnioOrigen[71].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato87) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato87) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[72].Value) || decimalIsZero(orientacionComercialTCAnioDestino[72].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[72].Value / orientacionComercialIPCAnioOrigen[72].Value) * (orientacionComercialTCAnioOrigen[72].Value / orientacionComercialTCAnioDestino[72].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[72].Value)) ? 0 : (orientacionComercialCPIAnioDestino[72].Value / orientacionComercialCPIAnioOrigen[72].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato88) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato88) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[73].Value) || decimalIsZero(orientacionComercialTCAnioDestino[73].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[73].Value / orientacionComercialIPCAnioOrigen[73].Value) * (orientacionComercialTCAnioOrigen[73].Value / orientacionComercialTCAnioDestino[73].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[73].Value)) ? 0 : (orientacionComercialCPIAnioDestino[73].Value / orientacionComercialCPIAnioOrigen[73].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato89) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato89) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[74].Value) || decimalIsZero(orientacionComercialTCAnioDestino[74].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[74].Value / orientacionComercialIPCAnioOrigen[74].Value) * (orientacionComercialTCAnioOrigen[74].Value / orientacionComercialTCAnioDestino[74].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[74].Value)) ? 0 : (orientacionComercialCPIAnioDestino[74].Value / orientacionComercialCPIAnioOrigen[74].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato90) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato90) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[75].Value) || decimalIsZero(orientacionComercialTCAnioDestino[75].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[75].Value / orientacionComercialIPCAnioOrigen[75].Value) * (orientacionComercialTCAnioOrigen[75].Value / orientacionComercialTCAnioDestino[75].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[75].Value)) ? 0 : (orientacionComercialCPIAnioDestino[75].Value / orientacionComercialCPIAnioOrigen[75].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato91) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato91) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[76].Value) || decimalIsZero(orientacionComercialTCAnioDestino[76].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[76].Value / orientacionComercialIPCAnioOrigen[76].Value) * (orientacionComercialTCAnioOrigen[76].Value / orientacionComercialTCAnioDestino[76].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[76].Value)) ? 0 : (orientacionComercialCPIAnioDestino[76].Value / orientacionComercialCPIAnioOrigen[76].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato92) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato92) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[77].Value) || decimalIsZero(orientacionComercialTCAnioDestino[77].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[77].Value / orientacionComercialIPCAnioOrigen[77].Value) * (orientacionComercialTCAnioOrigen[77].Value / orientacionComercialTCAnioDestino[77].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[77].Value)) ? 0 : (orientacionComercialCPIAnioDestino[77].Value / orientacionComercialCPIAnioOrigen[77].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato93) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato93) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[78].Value) || decimalIsZero(orientacionComercialTCAnioDestino[78].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[78].Value / orientacionComercialIPCAnioOrigen[78].Value) * (orientacionComercialTCAnioOrigen[78].Value / orientacionComercialTCAnioDestino[78].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[78].Value)) ? 0 : (orientacionComercialCPIAnioDestino[78].Value / orientacionComercialCPIAnioOrigen[78].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato94) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato94) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[79].Value) || decimalIsZero(orientacionComercialTCAnioDestino[79].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[79].Value / orientacionComercialIPCAnioOrigen[79].Value) * (orientacionComercialTCAnioOrigen[79].Value / orientacionComercialTCAnioDestino[79].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[79].Value)) ? 0 : (orientacionComercialCPIAnioDestino[79].Value / orientacionComercialCPIAnioOrigen[79].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato95) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato95) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                        ...
                                                        {
                                                            admMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDato0.ToString() });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato2);
                                                            ...
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            //diciembre
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[3].Value) || decimalIsZero(orientacionComercialTCAnioDestino[3].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[3].Value / orientacionComercialIPCAnioOrigen[3].Value) * (orientacionComercialTCAnioOrigen[3].Value / orientacionComercialTCAnioDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[3].Value)) ? 0 : (orientacionComercialCPIAnioDestino[3].Value / orientacionComercialCPIAnioOrigen[3].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato19) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato19) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[4].Value) || decimalIsZero(orientacionComercialTCAnioDestino[4].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[4].Value / orientacionComercialIPCAnioOrigen[4].Value) * (orientacionComercialTCAnioOrigen[4].Value / orientacionComercialTCAnioDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[4].Value)) ? 0 : (orientacionComercialCPIAnioDestino[4].Value / orientacionComercialCPIAnioOrigen[4].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato20) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato20) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[5].Value) || decimalIsZero(orientacionComercialTCAnioDestino[5].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[5].Value / orientacionComercialIPCAnioOrigen[5].Value) * (orientacionComercialTCAnioOrigen[5].Value / orientacionComercialTCAnioDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[5].Value)) ? 0 : (orientacionComercialCPIAnioDestino[5].Value / orientacionComercialCPIAnioOrigen[5].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato21) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato21) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[6].Value) || decimalIsZero(orientacionComercialTCAnioDestino[6].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[6].Value / orientacionComercialIPCAnioOrigen[6].Value) * (orientacionComercialTCAnioOrigen[6].Value / orientacionComercialTCAnioDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[6].Value)) ? 0 : (orientacionComercialCPIAnioDestino[6].Value / orientacionComercialCPIAnioOrigen[6].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato22) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato22) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[7].Value) || decimalIsZero(orientacionComercialTCAnioDestino[7].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[7].Value / orientacionComercialIPCAnioOrigen[7].Value) * (orientacionComercialTCAnioOrigen[7].Value / orientacionComercialTCAnioDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[7].Value)) ? 0 : (orientacionComercialCPIAnioDestino[7].Value / orientacionComercialCPIAnioOrigen[7].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato23) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato23) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[8].Value) || decimalIsZero(orientacionComercialTCAnioDestino[8].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[8].Value / orientacionComercialIPCAnioOrigen[8].Value) * (orientacionComercialTCAnioOrigen[8].Value / orientacionComercialTCAnioDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[8].Value)) ? 0 : (orientacionComercialCPIAnioDestino[8].Value / orientacionComercialCPIAnioOrigen[8].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato24) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato24) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[9].Value) || decimalIsZero(orientacionComercialTCAnioDestino[9].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[9].Value / orientacionComercialIPCAnioOrigen[9].Value) * (orientacionComercialTCAnioOrigen[9].Value / orientacionComercialTCAnioDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[9].Value)) ? 0 : (orientacionComercialCPIAnioDestino[9].Value / orientacionComercialCPIAnioOrigen[9].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato25) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato25) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[10].Value) || decimalIsZero(orientacionComercialTCAnioDestino[10].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[10].Value / orientacionComercialIPCAnioOrigen[10].Value) * (orientacionComercialTCAnioOrigen[10].Value / orientacionComercialTCAnioDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[10].Value)) ? 0 : (orientacionComercialCPIAnioDestino[10].Value / orientacionComercialCPIAnioOrigen[10].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato26) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato26) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[11].Value) || decimalIsZero(orientacionComercialTCAnioDestino[11].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[11].Value / orientacionComercialIPCAnioOrigen[11].Value) * (orientacionComercialTCAnioOrigen[11].Value / orientacionComercialTCAnioDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[11].Value)) ? 0 : (orientacionComercialCPIAnioDestino[11].Value / orientacionComercialCPIAnioOrigen[11].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato27) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato27) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[12].Value) || decimalIsZero(orientacionComercialTCAnioDestino[12].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[12].Value / orientacionComercialIPCAnioOrigen[12].Value) * (orientacionComercialTCAnioOrigen[12].Value / orientacionComercialTCAnioDestino[12].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[12].Value)) ? 0 : (orientacionComercialCPIAnioDestino[12].Value / orientacionComercialCPIAnioOrigen[12].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato28) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato28) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[13].Value) || decimalIsZero(orientacionComercialTCAnioDestino[13].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[13].Value / orientacionComercialIPCAnioOrigen[13].Value) * (orientacionComercialTCAnioOrigen[13].Value / orientacionComercialTCAnioDestino[13].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[13].Value)) ? 0 : (orientacionComercialCPIAnioDestino[13].Value / orientacionComercialCPIAnioOrigen[13].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato29) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato29) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[14].Value) || decimalIsZero(orientacionComercialTCAnioDestino[14].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[14].Value / orientacionComercialIPCAnioOrigen[14].Value) * (orientacionComercialTCAnioOrigen[14].Value / orientacionComercialTCAnioDestino[14].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[14].Value)) ? 0 : (orientacionComercialCPIAnioDestino[14].Value / orientacionComercialCPIAnioOrigen[14].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato30) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato30) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[15].Value) || decimalIsZero(orientacionComercialTCAnioDestino[15].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[15].Value / orientacionComercialIPCAnioOrigen[15].Value) * (orientacionComercialTCAnioOrigen[15].Value / orientacionComercialTCAnioDestino[15].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[15].Value)) ? 0 : (orientacionComercialCPIAnioDestino[15].Value / orientacionComercialCPIAnioOrigen[15].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato31) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato31) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[16].Value) || decimalIsZero(orientacionComercialTCAnioDestino[16].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[16].Value / orientacionComercialIPCAnioOrigen[16].Value) * (orientacionComercialTCAnioOrigen[16].Value / orientacionComercialTCAnioDestino[16].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[16].Value)) ? 0 : (orientacionComercialCPIAnioDestino[16].Value / orientacionComercialCPIAnioOrigen[16].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato32) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato32) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[17].Value) || decimalIsZero(orientacionComercialTCAnioDestino[17].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[17].Value / orientacionComercialIPCAnioOrigen[17].Value) * (orientacionComercialTCAnioOrigen[17].Value / orientacionComercialTCAnioDestino[17].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[17].Value)) ? 0 : (orientacionComercialCPIAnioDestino[17].Value / orientacionComercialCPIAnioOrigen[17].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato33) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato33) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[18].Value) || decimalIsZero(orientacionComercialTCAnioDestino[18].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[18].Value / orientacionComercialIPCAnioOrigen[18].Value) * (orientacionComercialTCAnioOrigen[18].Value / orientacionComercialTCAnioDestino[18].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[18].Value)) ? 0 : (orientacionComercialCPIAnioDestino[18].Value / orientacionComercialCPIAnioOrigen[18].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato34) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato34) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[19].Value) || decimalIsZero(orientacionComercialTCAnioDestino[19].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[19].Value / orientacionComercialIPCAnioOrigen[19].Value) * (orientacionComercialTCAnioOrigen[19].Value / orientacionComercialTCAnioDestino[19].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[19].Value)) ? 0 : (orientacionComercialCPIAnioDestino[19].Value / orientacionComercialCPIAnioOrigen[19].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato35) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato35) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[20].Value) || decimalIsZero(orientacionComercialTCAnioDestino[20].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[20].Value / orientacionComercialIPCAnioOrigen[20].Value) * (orientacionComercialTCAnioOrigen[20].Value / orientacionComercialTCAnioDestino[20].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[20].Value)) ? 0 : (orientacionComercialCPIAnioDestino[20].Value / orientacionComercialCPIAnioOrigen[20].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato36) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato36) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[21].Value) || decimalIsZero(orientacionComercialTCAnioDestino[21].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[21].Value / orientacionComercialIPCAnioOrigen[21].Value) * (orientacionComercialTCAnioOrigen[21].Value / orientacionComercialTCAnioDestino[21].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[21].Value)) ? 0 : (orientacionComercialCPIAnioDestino[21].Value / orientacionComercialCPIAnioOrigen[21].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato37) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato37) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[22].Value) || decimalIsZero(orientacionComercialTCAnioDestino[22].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[22].Value / orientacionComercialIPCAnioOrigen[22].Value) * (orientacionComercialTCAnioOrigen[22].Value / orientacionComercialTCAnioDestino[22].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[22].Value)) ? 0 : (orientacionComercialCPIAnioDestino[22].Value / orientacionComercialCPIAnioOrigen[22].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato38) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato38) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[23].Value) || decimalIsZero(orientacionComercialTCAnioDestino[23].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[23].Value / orientacionComercialIPCAnioOrigen[23].Value) * (orientacionComercialTCAnioOrigen[23].Value / orientacionComercialTCAnioDestino[23].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[23].Value)) ? 0 : (orientacionComercialCPIAnioDestino[23].Value / orientacionComercialCPIAnioOrigen[23].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato39) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato39) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[24].Value) || decimalIsZero(orientacionComercialTCAnioDestino[24].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[24].Value / orientacionComercialIPCAnioOrigen[24].Value) * (orientacionComercialTCAnioOrigen[24].Value / orientacionComercialTCAnioDestino[24].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[24].Value)) ? 0 : (orientacionComercialCPIAnioDestino[24].Value / orientacionComercialCPIAnioOrigen[24].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato40) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato40) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[25].Value) || decimalIsZero(orientacionComercialTCAnioDestino[25].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[25].Value / orientacionComercialIPCAnioOrigen[25].Value) * (orientacionComercialTCAnioOrigen[25].Value / orientacionComercialTCAnioDestino[25].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[25].Value)) ? 0 : (orientacionComercialCPIAnioDestino[25].Value / orientacionComercialCPIAnioOrigen[25].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato41) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato41) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[26].Value) || decimalIsZero(orientacionComercialTCAnioDestino[26].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[26].Value / orientacionComercialIPCAnioOrigen[26].Value) * (orientacionComercialTCAnioOrigen[26].Value / orientacionComercialTCAnioDestino[26].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[26].Value)) ? 0 : (orientacionComercialCPIAnioDestino[26].Value / orientacionComercialCPIAnioOrigen[26].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato42) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato42) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[27].Value) || decimalIsZero(orientacionComercialTCAnioDestino[27].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[27].Value / orientacionComercialIPCAnioOrigen[27].Value) * (orientacionComercialTCAnioOrigen[27].Value / orientacionComercialTCAnioDestino[27].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[27].Value)) ? 0 : (orientacionComercialCPIAnioDestino[27].Value / orientacionComercialCPIAnioOrigen[27].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato43) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato43) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[28].Value) || decimalIsZero(orientacionComercialTCAnioDestino[28].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[28].Value / orientacionComercialIPCAnioOrigen[28].Value) * (orientacionComercialTCAnioOrigen[28].Value / orientacionComercialTCAnioDestino[28].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[28].Value)) ? 0 : (orientacionComercialCPIAnioDestino[28].Value / orientacionComercialCPIAnioOrigen[28].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato44) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato44) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[29].Value) || decimalIsZero(orientacionComercialTCAnioDestino[29].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[29].Value / orientacionComercialIPCAnioOrigen[29].Value) * (orientacionComercialTCAnioOrigen[29].Value / orientacionComercialTCAnioDestino[29].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[29].Value)) ? 0 : (orientacionComercialCPIAnioDestino[29].Value / orientacionComercialCPIAnioOrigen[29].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato45) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato45) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[30].Value) || decimalIsZero(orientacionComercialTCAnioDestino[30].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[30].Value / orientacionComercialIPCAnioOrigen[30].Value) * (orientacionComercialTCAnioOrigen[30].Value / orientacionComercialTCAnioDestino[30].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[30].Value)) ? 0 : (orientacionComercialCPIAnioDestino[30].Value / orientacionComercialCPIAnioOrigen[30].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato46) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato46) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[31].Value) || decimalIsZero(orientacionComercialTCAnioDestino[31].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[31].Value / orientacionComercialIPCAnioOrigen[31].Value) * (orientacionComercialTCAnioOrigen[31].Value / orientacionComercialTCAnioDestino[31].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[31].Value)) ? 0 : (orientacionComercialCPIAnioDestino[31].Value / orientacionComercialCPIAnioOrigen[31].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato47) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato47) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[32].Value) || decimalIsZero(orientacionComercialTCAnioDestino[32].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[32].Value / orientacionComercialIPCAnioOrigen[32].Value) * (orientacionComercialTCAnioOrigen[32].Value / orientacionComercialTCAnioDestino[32].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[32].Value)) ? 0 : (orientacionComercialCPIAnioDestino[32].Value / orientacionComercialCPIAnioOrigen[32].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato48) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato48) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[33].Value) || decimalIsZero(orientacionComercialTCAnioDestino[33].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[33].Value / orientacionComercialIPCAnioOrigen[33].Value) * (orientacionComercialTCAnioOrigen[33].Value / orientacionComercialTCAnioDestino[33].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[33].Value)) ? 0 : (orientacionComercialCPIAnioDestino[33].Value / orientacionComercialCPIAnioOrigen[33].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato49) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato49) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[34].Value) || decimalIsZero(orientacionComercialTCAnioDestino[34].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[34].Value / orientacionComercialIPCAnioOrigen[34].Value) * (orientacionComercialTCAnioOrigen[34].Value / orientacionComercialTCAnioDestino[34].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[34].Value)) ? 0 : (orientacionComercialCPIAnioDestino[34].Value / orientacionComercialCPIAnioOrigen[34].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato50) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato50) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[35].Value) || decimalIsZero(orientacionComercialTCAnioDestino[35].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[35].Value / orientacionComercialIPCAnioOrigen[35].Value) * (orientacionComercialTCAnioOrigen[35].Value / orientacionComercialTCAnioDestino[35].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[35].Value)) ? 0 : (orientacionComercialCPIAnioDestino[35].Value / orientacionComercialCPIAnioOrigen[35].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato51) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato51) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[36].Value) || decimalIsZero(orientacionComercialTCAnioDestino[36].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[36].Value / orientacionComercialIPCAnioOrigen[36].Value) * (orientacionComercialTCAnioOrigen[36].Value / orientacionComercialTCAnioDestino[36].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[36].Value)) ? 0 : (orientacionComercialCPIAnioDestino[36].Value / orientacionComercialCPIAnioOrigen[36].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato52) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato52) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[37].Value) || decimalIsZero(orientacionComercialTCAnioDestino[37].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[37].Value / orientacionComercialIPCAnioOrigen[37].Value) * (orientacionComercialTCAnioOrigen[37].Value / orientacionComercialTCAnioDestino[37].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[37].Value)) ? 0 : (orientacionComercialCPIAnioDestino[37].Value / orientacionComercialCPIAnioOrigen[37].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato53) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato53) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[38].Value) || decimalIsZero(orientacionComercialTCAnioDestino[38].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[38].Value / orientacionComercialIPCAnioOrigen[38].Value) * (orientacionComercialTCAnioOrigen[38].Value / orientacionComercialTCAnioDestino[38].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[38].Value)) ? 0 : (orientacionComercialCPIAnioDestino[38].Value / orientacionComercialCPIAnioOrigen[38].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato54) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato54) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[39].Value) || decimalIsZero(orientacionComercialTCAnioDestino[39].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[39].Value / orientacionComercialIPCAnioOrigen[39].Value) * (orientacionComercialTCAnioOrigen[39].Value / orientacionComercialTCAnioDestino[39].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[39].Value)) ? 0 : (orientacionComercialCPIAnioDestino[39].Value / orientacionComercialCPIAnioOrigen[39].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato55) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato55) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[40].Value) || decimalIsZero(orientacionComercialTCAnioDestino[40].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[40].Value / orientacionComercialIPCAnioOrigen[40].Value) * (orientacionComercialTCAnioOrigen[40].Value / orientacionComercialTCAnioDestino[40].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[40].Value)) ? 0 : (orientacionComercialCPIAnioDestino[40].Value / orientacionComercialCPIAnioOrigen[40].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato56) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato56) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[41].Value) || decimalIsZero(orientacionComercialTCAnioDestino[41].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[41].Value / orientacionComercialIPCAnioOrigen[41].Value) * (orientacionComercialTCAnioOrigen[41].Value / orientacionComercialTCAnioDestino[41].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[41].Value)) ? 0 : (orientacionComercialCPIAnioDestino[41].Value / orientacionComercialCPIAnioOrigen[41].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato57) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato57) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[42].Value) || decimalIsZero(orientacionComercialTCAnioDestino[42].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[42].Value / orientacionComercialIPCAnioOrigen[42].Value) * (orientacionComercialTCAnioOrigen[42].Value / orientacionComercialTCAnioDestino[42].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[42].Value)) ? 0 : (orientacionComercialCPIAnioDestino[42].Value / orientacionComercialCPIAnioOrigen[42].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato58) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato58) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[43].Value) || decimalIsZero(orientacionComercialTCAnioDestino[43].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[43].Value / orientacionComercialIPCAnioOrigen[43].Value) * (orientacionComercialTCAnioOrigen[43].Value / orientacionComercialTCAnioDestino[43].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[43].Value)) ? 0 : (orientacionComercialCPIAnioDestino[43].Value / orientacionComercialCPIAnioOrigen[43].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato59) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato59) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[44].Value) || decimalIsZero(orientacionComercialTCAnioDestino[44].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[44].Value / orientacionComercialIPCAnioOrigen[44].Value) * (orientacionComercialTCAnioOrigen[44].Value / orientacionComercialTCAnioDestino[44].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[44].Value)) ? 0 : (orientacionComercialCPIAnioDestino[44].Value / orientacionComercialCPIAnioOrigen[44].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato60) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato60) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[45].Value) || decimalIsZero(orientacionComercialTCAnioDestino[45].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[45].Value / orientacionComercialIPCAnioOrigen[45].Value) * (orientacionComercialTCAnioOrigen[45].Value / orientacionComercialTCAnioDestino[45].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[45].Value)) ? 0 : (orientacionComercialCPIAnioDestino[45].Value / orientacionComercialCPIAnioOrigen[45].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato61) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato61) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[46].Value) || decimalIsZero(orientacionComercialTCAnioDestino[46].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[46].Value / orientacionComercialIPCAnioOrigen[46].Value) * (orientacionComercialTCAnioOrigen[46].Value / orientacionComercialTCAnioDestino[46].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[46].Value)) ? 0 : (orientacionComercialCPIAnioDestino[46].Value / orientacionComercialCPIAnioOrigen[46].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato62) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato62) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[47].Value) || decimalIsZero(orientacionComercialTCAnioDestino[47].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[47].Value / orientacionComercialIPCAnioOrigen[47].Value) * (orientacionComercialTCAnioOrigen[47].Value / orientacionComercialTCAnioDestino[47].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[47].Value)) ? 0 : (orientacionComercialCPIAnioDestino[47].Value / orientacionComercialCPIAnioOrigen[47].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato63) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato63) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[48].Value) || decimalIsZero(orientacionComercialTCAnioDestino[48].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[48].Value / orientacionComercialIPCAnioOrigen[48].Value) * (orientacionComercialTCAnioOrigen[48].Value / orientacionComercialTCAnioDestino[48].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[48].Value)) ? 0 : (orientacionComercialCPIAnioDestino[48].Value / orientacionComercialCPIAnioOrigen[48].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato64) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato64) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[49].Value) || decimalIsZero(orientacionComercialTCAnioDestino[49].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[49].Value / orientacionComercialIPCAnioOrigen[49].Value) * (orientacionComercialTCAnioOrigen[49].Value / orientacionComercialTCAnioDestino[49].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[49].Value)) ? 0 : (orientacionComercialCPIAnioDestino[49].Value / orientacionComercialCPIAnioOrigen[49].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato65) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato65) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[50].Value) || decimalIsZero(orientacionComercialTCAnioDestino[50].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[50].Value / orientacionComercialIPCAnioOrigen[50].Value) * (orientacionComercialTCAnioOrigen[50].Value / orientacionComercialTCAnioDestino[50].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[50].Value)) ? 0 : (orientacionComercialCPIAnioDestino[50].Value / orientacionComercialCPIAnioOrigen[50].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato66) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato66) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[51].Value) || decimalIsZero(orientacionComercialTCAnioDestino[51].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[51].Value / orientacionComercialIPCAnioOrigen[51].Value) * (orientacionComercialTCAnioOrigen[51].Value / orientacionComercialTCAnioDestino[51].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[51].Value)) ? 0 : (orientacionComercialCPIAnioDestino[51].Value / orientacionComercialCPIAnioOrigen[51].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato67) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato67) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[52].Value) || decimalIsZero(orientacionComercialTCAnioDestino[52].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[52].Value / orientacionComercialIPCAnioOrigen[52].Value) * (orientacionComercialTCAnioOrigen[52].Value / orientacionComercialTCAnioDestino[52].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[52].Value)) ? 0 : (orientacionComercialCPIAnioDestino[52].Value / orientacionComercialCPIAnioOrigen[52].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato68) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato68) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[53].Value) || decimalIsZero(orientacionComercialTCAnioDestino[53].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[53].Value / orientacionComercialIPCAnioOrigen[53].Value) * (orientacionComercialTCAnioOrigen[53].Value / orientacionComercialTCAnioDestino[53].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[53].Value)) ? 0 : (orientacionComercialCPIAnioDestino[53].Value / orientacionComercialCPIAnioOrigen[53].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato69) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato69) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[54].Value) || decimalIsZero(orientacionComercialTCAnioDestino[54].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[54].Value / orientacionComercialIPCAnioOrigen[54].Value) * (orientacionComercialTCAnioOrigen[54].Value / orientacionComercialTCAnioDestino[54].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[54].Value)) ? 0 : (orientacionComercialCPIAnioDestino[54].Value / orientacionComercialCPIAnioOrigen[54].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato70) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato70) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[55].Value) || decimalIsZero(orientacionComercialTCAnioDestino[55].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[55].Value / orientacionComercialIPCAnioOrigen[55].Value) * (orientacionComercialTCAnioOrigen[55].Value / orientacionComercialTCAnioDestino[55].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[55].Value)) ? 0 : (orientacionComercialCPIAnioDestino[55].Value / orientacionComercialCPIAnioOrigen[55].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato71) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato71) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[56].Value) || decimalIsZero(orientacionComercialTCAnioDestino[56].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[56].Value / orientacionComercialIPCAnioOrigen[56].Value) * (orientacionComercialTCAnioOrigen[56].Value / orientacionComercialTCAnioDestino[56].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[56].Value)) ? 0 : (orientacionComercialCPIAnioDestino[56].Value / orientacionComercialCPIAnioOrigen[56].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato72) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato72) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[57].Value) || decimalIsZero(orientacionComercialTCAnioDestino[57].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[57].Value / orientacionComercialIPCAnioOrigen[57].Value) * (orientacionComercialTCAnioOrigen[57].Value / orientacionComercialTCAnioDestino[57].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[57].Value)) ? 0 : (orientacionComercialCPIAnioDestino[57].Value / orientacionComercialCPIAnioOrigen[57].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato73) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato73) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[58].Value) || decimalIsZero(orientacionComercialTCAnioDestino[58].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[58].Value / orientacionComercialIPCAnioOrigen[58].Value) * (orientacionComercialTCAnioOrigen[58].Value / orientacionComercialTCAnioDestino[58].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[58].Value)) ? 0 : (orientacionComercialCPIAnioDestino[58].Value / orientacionComercialCPIAnioOrigen[58].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato74) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato74) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[59].Value) || decimalIsZero(orientacionComercialTCAnioDestino[59].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[59].Value / orientacionComercialIPCAnioOrigen[59].Value) * (orientacionComercialTCAnioOrigen[59].Value / orientacionComercialTCAnioDestino[59].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[59].Value)) ? 0 : (orientacionComercialCPIAnioDestino[59].Value / orientacionComercialCPIAnioOrigen[59].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato75) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato75) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[60].Value) || decimalIsZero(orientacionComercialTCAnioDestino[60].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[60].Value / orientacionComercialIPCAnioOrigen[60].Value) * (orientacionComercialTCAnioOrigen[60].Value / orientacionComercialTCAnioDestino[60].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[60].Value)) ? 0 : (orientacionComercialCPIAnioDestino[60].Value / orientacionComercialCPIAnioOrigen[60].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato76) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato76) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[61].Value) || decimalIsZero(orientacionComercialTCAnioDestino[61].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[61].Value / orientacionComercialIPCAnioOrigen[61].Value) * (orientacionComercialTCAnioOrigen[61].Value / orientacionComercialTCAnioDestino[61].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[61].Value)) ? 0 : (orientacionComercialCPIAnioDestino[61].Value / orientacionComercialCPIAnioOrigen[61].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato77) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato77) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[62].Value) || decimalIsZero(orientacionComercialTCAnioDestino[62].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[62].Value / orientacionComercialIPCAnioOrigen[62].Value) * (orientacionComercialTCAnioOrigen[62].Value / orientacionComercialTCAnioDestino[62].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[62].Value)) ? 0 : (orientacionComercialCPIAnioDestino[62].Value / orientacionComercialCPIAnioOrigen[62].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato78) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato78) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[63].Value) || decimalIsZero(orientacionComercialTCAnioDestino[63].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[63].Value / orientacionComercialIPCAnioOrigen[63].Value) * (orientacionComercialTCAnioOrigen[63].Value / orientacionComercialTCAnioDestino[63].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[63].Value)) ? 0 : (orientacionComercialCPIAnioDestino[63].Value / orientacionComercialCPIAnioOrigen[63].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato79) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato79) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[64].Value) || decimalIsZero(orientacionComercialTCAnioDestino[64].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[64].Value / orientacionComercialIPCAnioOrigen[64].Value) * (orientacionComercialTCAnioOrigen[64].Value / orientacionComercialTCAnioDestino[64].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[64].Value)) ? 0 : (orientacionComercialCPIAnioDestino[64].Value / orientacionComercialCPIAnioOrigen[64].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato80) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato80) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[65].Value) || decimalIsZero(orientacionComercialTCAnioDestino[65].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[65].Value / orientacionComercialIPCAnioOrigen[65].Value) * (orientacionComercialTCAnioOrigen[65].Value / orientacionComercialTCAnioDestino[65].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[65].Value)) ? 0 : (orientacionComercialCPIAnioDestino[65].Value / orientacionComercialCPIAnioOrigen[65].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato81) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato81) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[66].Value) || decimalIsZero(orientacionComercialTCAnioDestino[66].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[66].Value / orientacionComercialIPCAnioOrigen[66].Value) * (orientacionComercialTCAnioOrigen[66].Value / orientacionComercialTCAnioDestino[66].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[66].Value)) ? 0 : (orientacionComercialCPIAnioDestino[66].Value / orientacionComercialCPIAnioOrigen[66].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato82) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato82) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[67].Value) || decimalIsZero(orientacionComercialTCAnioDestino[67].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[67].Value / orientacionComercialIPCAnioOrigen[67].Value) * (orientacionComercialTCAnioOrigen[67].Value / orientacionComercialTCAnioDestino[67].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[67].Value)) ? 0 : (orientacionComercialCPIAnioDestino[67].Value / orientacionComercialCPIAnioOrigen[67].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato83) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato83) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[68].Value) || decimalIsZero(orientacionComercialTCAnioDestino[68].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[68].Value / orientacionComercialIPCAnioOrigen[68].Value) * (orientacionComercialTCAnioOrigen[68].Value / orientacionComercialTCAnioDestino[68].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[68].Value)) ? 0 : (orientacionComercialCPIAnioDestino[68].Value / orientacionComercialCPIAnioOrigen[68].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato84) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato84) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[69].Value) || decimalIsZero(orientacionComercialTCAnioDestino[69].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[69].Value / orientacionComercialIPCAnioOrigen[69].Value) * (orientacionComercialTCAnioOrigen[69].Value / orientacionComercialTCAnioDestino[69].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[69].Value)) ? 0 : (orientacionComercialCPIAnioDestino[69].Value / orientacionComercialCPIAnioOrigen[69].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato85) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato85) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[70].Value) || decimalIsZero(orientacionComercialTCAnioDestino[70].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[70].Value / orientacionComercialIPCAnioOrigen[70].Value) * (orientacionComercialTCAnioOrigen[70].Value / orientacionComercialTCAnioDestino[70].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[70].Value)) ? 0 : (orientacionComercialCPIAnioDestino[70].Value / orientacionComercialCPIAnioOrigen[70].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato86) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato86) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[71].Value) || decimalIsZero(orientacionComercialTCAnioDestino[71].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[71].Value / orientacionComercialIPCAnioOrigen[71].Value) * (orientacionComercialTCAnioOrigen[71].Value / orientacionComercialTCAnioDestino[71].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[71].Value)) ? 0 : (orientacionComercialCPIAnioDestino[71].Value / orientacionComercialCPIAnioOrigen[71].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato87) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato87) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[72].Value) || decimalIsZero(orientacionComercialTCAnioDestino[72].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[72].Value / orientacionComercialIPCAnioOrigen[72].Value) * (orientacionComercialTCAnioOrigen[72].Value / orientacionComercialTCAnioDestino[72].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[72].Value)) ? 0 : (orientacionComercialCPIAnioDestino[72].Value / orientacionComercialCPIAnioOrigen[72].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato88) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato88) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[73].Value) || decimalIsZero(orientacionComercialTCAnioDestino[73].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[73].Value / orientacionComercialIPCAnioOrigen[73].Value) * (orientacionComercialTCAnioOrigen[73].Value / orientacionComercialTCAnioDestino[73].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[73].Value)) ? 0 : (orientacionComercialCPIAnioDestino[73].Value / orientacionComercialCPIAnioOrigen[73].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato89) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato89) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[74].Value) || decimalIsZero(orientacionComercialTCAnioDestino[74].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[74].Value / orientacionComercialIPCAnioOrigen[74].Value) * (orientacionComercialTCAnioOrigen[74].Value / orientacionComercialTCAnioDestino[74].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[74].Value)) ? 0 : (orientacionComercialCPIAnioDestino[74].Value / orientacionComercialCPIAnioOrigen[74].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato90) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato90) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[75].Value) || decimalIsZero(orientacionComercialTCAnioDestino[75].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[75].Value / orientacionComercialIPCAnioOrigen[75].Value) * (orientacionComercialTCAnioOrigen[75].Value / orientacionComercialTCAnioDestino[75].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[75].Value)) ? 0 : (orientacionComercialCPIAnioDestino[75].Value / orientacionComercialCPIAnioOrigen[75].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato91) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato91) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[76].Value) || decimalIsZero(orientacionComercialTCAnioDestino[76].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[76].Value / orientacionComercialIPCAnioOrigen[76].Value) * (orientacionComercialTCAnioOrigen[76].Value / orientacionComercialTCAnioDestino[76].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[76].Value)) ? 0 : (orientacionComercialCPIAnioDestino[76].Value / orientacionComercialCPIAnioOrigen[76].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato92) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato92) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[77].Value) || decimalIsZero(orientacionComercialTCAnioDestino[77].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[77].Value / orientacionComercialIPCAnioOrigen[77].Value) * (orientacionComercialTCAnioOrigen[77].Value / orientacionComercialTCAnioDestino[77].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[77].Value)) ? 0 : (orientacionComercialCPIAnioDestino[77].Value / orientacionComercialCPIAnioOrigen[77].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato93) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato93) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[78].Value) || decimalIsZero(orientacionComercialTCAnioDestino[78].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[78].Value / orientacionComercialIPCAnioOrigen[78].Value) * (orientacionComercialTCAnioOrigen[78].Value / orientacionComercialTCAnioDestino[78].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[78].Value)) ? 0 : (orientacionComercialCPIAnioDestino[78].Value / orientacionComercialCPIAnioOrigen[78].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato94) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato94) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[79].Value) || decimalIsZero(orientacionComercialTCAnioDestino[79].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[79].Value / orientacionComercialIPCAnioOrigen[79].Value) * (orientacionComercialTCAnioOrigen[79].Value / orientacionComercialTCAnioDestino[79].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[79].Value)) ? 0 : (orientacionComercialCPIAnioDestino[79].Value / orientacionComercialCPIAnioOrigen[79].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato95) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato95) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                        ...
                                                        {
                                                            contMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDato0.ToString() });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato2);
                                                            ...
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            //diciembre
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[3].Value) || decimalIsZero(orientacionComercialTCAnioDestino[3].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[3].Value / orientacionComercialIPCAnioOrigen[3].Value) * (orientacionComercialTCAnioOrigen[3].Value / orientacionComercialTCAnioDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[3].Value)) ? 0 : (orientacionComercialCPIAnioDestino[3].Value / orientacionComercialCPIAnioOrigen[3].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato19) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato19) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[4].Value) || decimalIsZero(orientacionComercialTCAnioDestino[4].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[4].Value / orientacionComercialIPCAnioOrigen[4].Value) * (orientacionComercialTCAnioOrigen[4].Value / orientacionComercialTCAnioDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[4].Value)) ? 0 : (orientacionComercialCPIAnioDestino[4].Value / orientacionComercialCPIAnioOrigen[4].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato20) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato20) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[5].Value) || decimalIsZero(orientacionComercialTCAnioDestino[5].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[5].Value / orientacionComercialIPCAnioOrigen[5].Value) * (orientacionComercialTCAnioOrigen[5].Value / orientacionComercialTCAnioDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[5].Value)) ? 0 : (orientacionComercialCPIAnioDestino[5].Value / orientacionComercialCPIAnioOrigen[5].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato21) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato21) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[6].Value) || decimalIsZero(orientacionComercialTCAnioDestino[6].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[6].Value / orientacionComercialIPCAnioOrigen[6].Value) * (orientacionComercialTCAnioOrigen[6].Value / orientacionComercialTCAnioDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[6].Value)) ? 0 : (orientacionComercialCPIAnioDestino[6].Value / orientacionComercialCPIAnioOrigen[6].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato22) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato22) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[7].Value) || decimalIsZero(orientacionComercialTCAnioDestino[7].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[7].Value / orientacionComercialIPCAnioOrigen[7].Value) * (orientacionComercialTCAnioOrigen[7].Value / orientacionComercialTCAnioDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[7].Value)) ? 0 : (orientacionComercialCPIAnioDestino[7].Value / orientacionComercialCPIAnioOrigen[7].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato23) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato23) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[8].Value) || decimalIsZero(orientacionComercialTCAnioDestino[8].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[8].Value / orientacionComercialIPCAnioOrigen[8].Value) * (orientacionComercialTCAnioOrigen[8].Value / orientacionComercialTCAnioDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[8].Value)) ? 0 : (orientacionComercialCPIAnioDestino[8].Value / orientacionComercialCPIAnioOrigen[8].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato24) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato24) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[9].Value) || decimalIsZero(orientacionComercialTCAnioDestino[9].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[9].Value / orientacionComercialIPCAnioOrigen[9].Value) * (orientacionComercialTCAnioOrigen[9].Value / orientacionComercialTCAnioDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[9].Value)) ? 0 : (orientacionComercialCPIAnioDestino[9].Value / orientacionComercialCPIAnioOrigen[9].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato25) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato25) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[10].Value) || decimalIsZero(orientacionComercialTCAnioDestino[10].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[10].Value / orientacionComercialIPCAnioOrigen[10].Value) * (orientacionComercialTCAnioOrigen[10].Value / orientacionComercialTCAnioDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[10].Value)) ? 0 : (orientacionComercialCPIAnioDestino[10].Value / orientacionComercialCPIAnioOrigen[10].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato26) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato26) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[11].Value) || decimalIsZero(orientacionComercialTCAnioDestino[11].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[11].Value / orientacionComercialIPCAnioOrigen[11].Value) * (orientacionComercialTCAnioOrigen[11].Value / orientacionComercialTCAnioDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[11].Value)) ? 0 : (orientacionComercialCPIAnioDestino[11].Value / orientacionComercialCPIAnioOrigen[11].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato27) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato27) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[12].Value) || decimalIsZero(orientacionComercialTCAnioDestino[12].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[12].Value / orientacionComercialIPCAnioOrigen[12].Value) * (orientacionComercialTCAnioOrigen[12].Value / orientacionComercialTCAnioDestino[12].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[12].Value)) ? 0 : (orientacionComercialCPIAnioDestino[12].Value / orientacionComercialCPIAnioOrigen[12].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato28) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato28) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[13].Value) || decimalIsZero(orientacionComercialTCAnioDestino[13].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[13].Value / orientacionComercialIPCAnioOrigen[13].Value) * (orientacionComercialTCAnioOrigen[13].Value / orientacionComercialTCAnioDestino[13].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[13].Value)) ? 0 : (orientacionComercialCPIAnioDestino[13].Value / orientacionComercialCPIAnioOrigen[13].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato29) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato29) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[14].Value) || decimalIsZero(orientacionComercialTCAnioDestino[14].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[14].Value / orientacionComercialIPCAnioOrigen[14].Value) * (orientacionComercialTCAnioOrigen[14].Value / orientacionComercialTCAnioDestino[14].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[14].Value)) ? 0 : (orientacionComercialCPIAnioDestino[14].Value / orientacionComercialCPIAnioOrigen[14].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato30) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato30) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[15].Value) || decimalIsZero(orientacionComercialTCAnioDestino[15].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[15].Value / orientacionComercialIPCAnioOrigen[15].Value) * (orientacionComercialTCAnioOrigen[15].Value / orientacionComercialTCAnioDestino[15].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[15].Value)) ? 0 : (orientacionComercialCPIAnioDestino[15].Value / orientacionComercialCPIAnioOrigen[15].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato31) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato31) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[16].Value) || decimalIsZero(orientacionComercialTCAnioDestino[16].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[16].Value / orientacionComercialIPCAnioOrigen[16].Value) * (orientacionComercialTCAnioOrigen[16].Value / orientacionComercialTCAnioDestino[16].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[16].Value)) ? 0 : (orientacionComercialCPIAnioDestino[16].Value / orientacionComercialCPIAnioOrigen[16].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato32) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato32) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[17].Value) || decimalIsZero(orientacionComercialTCAnioDestino[17].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[17].Value / orientacionComercialIPCAnioOrigen[17].Value) * (orientacionComercialTCAnioOrigen[17].Value / orientacionComercialTCAnioDestino[17].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[17].Value)) ? 0 : (orientacionComercialCPIAnioDestino[17].Value / orientacionComercialCPIAnioOrigen[17].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato33) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato33) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[18].Value) || decimalIsZero(orientacionComercialTCAnioDestino[18].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[18].Value / orientacionComercialIPCAnioOrigen[18].Value) * (orientacionComercialTCAnioOrigen[18].Value / orientacionComercialTCAnioDestino[18].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[18].Value)) ? 0 : (orientacionComercialCPIAnioDestino[18].Value / orientacionComercialCPIAnioOrigen[18].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato34) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato34) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[19].Value) || decimalIsZero(orientacionComercialTCAnioDestino[19].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[19].Value / orientacionComercialIPCAnioOrigen[19].Value) * (orientacionComercialTCAnioOrigen[19].Value / orientacionComercialTCAnioDestino[19].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[19].Value)) ? 0 : (orientacionComercialCPIAnioDestino[19].Value / orientacionComercialCPIAnioOrigen[19].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato35) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato35) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[20].Value) || decimalIsZero(orientacionComercialTCAnioDestino[20].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[20].Value / orientacionComercialIPCAnioOrigen[20].Value) * (orientacionComercialTCAnioOrigen[20].Value / orientacionComercialTCAnioDestino[20].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[20].Value)) ? 0 : (orientacionComercialCPIAnioDestino[20].Value / orientacionComercialCPIAnioOrigen[20].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato36) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato36) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[21].Value) || decimalIsZero(orientacionComercialTCAnioDestino[21].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[21].Value / orientacionComercialIPCAnioOrigen[21].Value) * (orientacionComercialTCAnioOrigen[21].Value / orientacionComercialTCAnioDestino[21].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[21].Value)) ? 0 : (orientacionComercialCPIAnioDestino[21].Value / orientacionComercialCPIAnioOrigen[21].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato37) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato37) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[22].Value) || decimalIsZero(orientacionComercialTCAnioDestino[22].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[22].Value / orientacionComercialIPCAnioOrigen[22].Value) * (orientacionComercialTCAnioOrigen[22].Value / orientacionComercialTCAnioDestino[22].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[22].Value)) ? 0 : (orientacionComercialCPIAnioDestino[22].Value / orientacionComercialCPIAnioOrigen[22].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato38) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato38) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[23].Value) || decimalIsZero(orientacionComercialTCAnioDestino[23].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[23].Value / orientacionComercialIPCAnioOrigen[23].Value) * (orientacionComercialTCAnioOrigen[23].Value / orientacionComercialTCAnioDestino[23].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[23].Value)) ? 0 : (orientacionComercialCPIAnioDestino[23].Value / orientacionComercialCPIAnioOrigen[23].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato39) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato39) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[24].Value) || decimalIsZero(orientacionComercialTCAnioDestino[24].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[24].Value / orientacionComercialIPCAnioOrigen[24].Value) * (orientacionComercialTCAnioOrigen[24].Value / orientacionComercialTCAnioDestino[24].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[24].Value)) ? 0 : (orientacionComercialCPIAnioDestino[24].Value / orientacionComercialCPIAnioOrigen[24].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato40) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato40) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[25].Value) || decimalIsZero(orientacionComercialTCAnioDestino[25].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[25].Value / orientacionComercialIPCAnioOrigen[25].Value) * (orientacionComercialTCAnioOrigen[25].Value / orientacionComercialTCAnioDestino[25].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[25].Value)) ? 0 : (orientacionComercialCPIAnioDestino[25].Value / orientacionComercialCPIAnioOrigen[25].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato41) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato41) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[26].Value) || decimalIsZero(orientacionComercialTCAnioDestino[26].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[26].Value / orientacionComercialIPCAnioOrigen[26].Value) * (orientacionComercialTCAnioOrigen[26].Value / orientacionComercialTCAnioDestino[26].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[26].Value)) ? 0 : (orientacionComercialCPIAnioDestino[26].Value / orientacionComercialCPIAnioOrigen[26].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato42) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato42) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[27].Value) || decimalIsZero(orientacionComercialTCAnioDestino[27].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[27].Value / orientacionComercialIPCAnioOrigen[27].Value) * (orientacionComercialTCAnioOrigen[27].Value / orientacionComercialTCAnioDestino[27].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[27].Value)) ? 0 : (orientacionComercialCPIAnioDestino[27].Value / orientacionComercialCPIAnioOrigen[27].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato43) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato43) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[28].Value) || decimalIsZero(orientacionComercialTCAnioDestino[28].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[28].Value / orientacionComercialIPCAnioOrigen[28].Value) * (orientacionComercialTCAnioOrigen[28].Value / orientacionComercialTCAnioDestino[28].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[28].Value)) ? 0 : (orientacionComercialCPIAnioDestino[28].Value / orientacionComercialCPIAnioOrigen[28].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato44) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato44) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[29].Value) || decimalIsZero(orientacionComercialTCAnioDestino[29].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[29].Value / orientacionComercialIPCAnioOrigen[29].Value) * (orientacionComercialTCAnioOrigen[29].Value / orientacionComercialTCAnioDestino[29].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[29].Value)) ? 0 : (orientacionComercialCPIAnioDestino[29].Value / orientacionComercialCPIAnioOrigen[29].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato45) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato45) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[30].Value) || decimalIsZero(orientacionComercialTCAnioDestino[30].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[30].Value / orientacionComercialIPCAnioOrigen[30].Value) * (orientacionComercialTCAnioOrigen[30].Value / orientacionComercialTCAnioDestino[30].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[30].Value)) ? 0 : (orientacionComercialCPIAnioDestino[30].Value / orientacionComercialCPIAnioOrigen[30].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato46) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato46) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[31].Value) || decimalIsZero(orientacionComercialTCAnioDestino[31].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[31].Value / orientacionComercialIPCAnioOrigen[31].Value) * (orientacionComercialTCAnioOrigen[31].Value / orientacionComercialTCAnioDestino[31].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[31].Value)) ? 0 : (orientacionComercialCPIAnioDestino[31].Value / orientacionComercialCPIAnioOrigen[31].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato47) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato47) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[32].Value) || decimalIsZero(orientacionComercialTCAnioDestino[32].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[32].Value / orientacionComercialIPCAnioOrigen[32].Value) * (orientacionComercialTCAnioOrigen[32].Value / orientacionComercialTCAnioDestino[32].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[32].Value)) ? 0 : (orientacionComercialCPIAnioDestino[32].Value / orientacionComercialCPIAnioOrigen[32].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato48) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato48) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[33].Value) || decimalIsZero(orientacionComercialTCAnioDestino[33].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[33].Value / orientacionComercialIPCAnioOrigen[33].Value) * (orientacionComercialTCAnioOrigen[33].Value / orientacionComercialTCAnioDestino[33].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[33].Value)) ? 0 : (orientacionComercialCPIAnioDestino[33].Value / orientacionComercialCPIAnioOrigen[33].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato49) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato49) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[34].Value) || decimalIsZero(orientacionComercialTCAnioDestino[34].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[34].Value / orientacionComercialIPCAnioOrigen[34].Value) * (orientacionComercialTCAnioOrigen[34].Value / orientacionComercialTCAnioDestino[34].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[34].Value)) ? 0 : (orientacionComercialCPIAnioDestino[34].Value / orientacionComercialCPIAnioOrigen[34].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato50) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato50) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[35].Value) || decimalIsZero(orientacionComercialTCAnioDestino[35].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[35].Value / orientacionComercialIPCAnioOrigen[35].Value) * (orientacionComercialTCAnioOrigen[35].Value / orientacionComercialTCAnioDestino[35].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[35].Value)) ? 0 : (orientacionComercialCPIAnioDestino[35].Value / orientacionComercialCPIAnioOrigen[35].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato51) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato51) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[36].Value) || decimalIsZero(orientacionComercialTCAnioDestino[36].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[36].Value / orientacionComercialIPCAnioOrigen[36].Value) * (orientacionComercialTCAnioOrigen[36].Value / orientacionComercialTCAnioDestino[36].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[36].Value)) ? 0 : (orientacionComercialCPIAnioDestino[36].Value / orientacionComercialCPIAnioOrigen[36].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato52) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato52) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[37].Value) || decimalIsZero(orientacionComercialTCAnioDestino[37].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[37].Value / orientacionComercialIPCAnioOrigen[37].Value) * (orientacionComercialTCAnioOrigen[37].Value / orientacionComercialTCAnioDestino[37].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[37].Value)) ? 0 : (orientacionComercialCPIAnioDestino[37].Value / orientacionComercialCPIAnioOrigen[37].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato53) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato53) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[38].Value) || decimalIsZero(orientacionComercialTCAnioDestino[38].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[38].Value / orientacionComercialIPCAnioOrigen[38].Value) * (orientacionComercialTCAnioOrigen[38].Value / orientacionComercialTCAnioDestino[38].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[38].Value)) ? 0 : (orientacionComercialCPIAnioDestino[38].Value / orientacionComercialCPIAnioOrigen[38].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato54) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato54) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[39].Value) || decimalIsZero(orientacionComercialTCAnioDestino[39].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[39].Value / orientacionComercialIPCAnioOrigen[39].Value) * (orientacionComercialTCAnioOrigen[39].Value / orientacionComercialTCAnioDestino[39].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[39].Value)) ? 0 : (orientacionComercialCPIAnioDestino[39].Value / orientacionComercialCPIAnioOrigen[39].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato55) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato55) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[40].Value) || decimalIsZero(orientacionComercialTCAnioDestino[40].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[40].Value / orientacionComercialIPCAnioOrigen[40].Value) * (orientacionComercialTCAnioOrigen[40].Value / orientacionComercialTCAnioDestino[40].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[40].Value)) ? 0 : (orientacionComercialCPIAnioDestino[40].Value / orientacionComercialCPIAnioOrigen[40].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato56) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato56) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[41].Value) || decimalIsZero(orientacionComercialTCAnioDestino[41].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[41].Value / orientacionComercialIPCAnioOrigen[41].Value) * (orientacionComercialTCAnioOrigen[41].Value / orientacionComercialTCAnioDestino[41].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[41].Value)) ? 0 : (orientacionComercialCPIAnioDestino[41].Value / orientacionComercialCPIAnioOrigen[41].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato57) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato57) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[42].Value) || decimalIsZero(orientacionComercialTCAnioDestino[42].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[42].Value / orientacionComercialIPCAnioOrigen[42].Value) * (orientacionComercialTCAnioOrigen[42].Value / orientacionComercialTCAnioDestino[42].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[42].Value)) ? 0 : (orientacionComercialCPIAnioDestino[42].Value / orientacionComercialCPIAnioOrigen[42].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato58) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato58) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[43].Value) || decimalIsZero(orientacionComercialTCAnioDestino[43].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[43].Value / orientacionComercialIPCAnioOrigen[43].Value) * (orientacionComercialTCAnioOrigen[43].Value / orientacionComercialTCAnioDestino[43].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[43].Value)) ? 0 : (orientacionComercialCPIAnioDestino[43].Value / orientacionComercialCPIAnioOrigen[43].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato59) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato59) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[44].Value) || decimalIsZero(orientacionComercialTCAnioDestino[44].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[44].Value / orientacionComercialIPCAnioOrigen[44].Value) * (orientacionComercialTCAnioOrigen[44].Value / orientacionComercialTCAnioDestino[44].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[44].Value)) ? 0 : (orientacionComercialCPIAnioDestino[44].Value / orientacionComercialCPIAnioOrigen[44].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato60) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato60) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[45].Value) || decimalIsZero(orientacionComercialTCAnioDestino[45].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[45].Value / orientacionComercialIPCAnioOrigen[45].Value) * (orientacionComercialTCAnioOrigen[45].Value / orientacionComercialTCAnioDestino[45].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[45].Value)) ? 0 : (orientacionComercialCPIAnioDestino[45].Value / orientacionComercialCPIAnioOrigen[45].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato61) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato61) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[46].Value) || decimalIsZero(orientacionComercialTCAnioDestino[46].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[46].Value / orientacionComercialIPCAnioOrigen[46].Value) * (orientacionComercialTCAnioOrigen[46].Value / orientacionComercialTCAnioDestino[46].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[46].Value)) ? 0 : (orientacionComercialCPIAnioDestino[46].Value / orientacionComercialCPIAnioOrigen[46].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato62) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato62) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[47].Value) || decimalIsZero(orientacionComercialTCAnioDestino[47].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[47].Value / orientacionComercialIPCAnioOrigen[47].Value) * (orientacionComercialTCAnioOrigen[47].Value / orientacionComercialTCAnioDestino[47].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[47].Value)) ? 0 : (orientacionComercialCPIAnioDestino[47].Value / orientacionComercialCPIAnioOrigen[47].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato63) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato63) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[48].Value) || decimalIsZero(orientacionComercialTCAnioDestino[48].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[48].Value / orientacionComercialIPCAnioOrigen[48].Value) * (orientacionComercialTCAnioOrigen[48].Value / orientacionComercialTCAnioDestino[48].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[48].Value)) ? 0 : (orientacionComercialCPIAnioDestino[48].Value / orientacionComercialCPIAnioOrigen[48].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato64) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato64) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[49].Value) || decimalIsZero(orientacionComercialTCAnioDestino[49].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[49].Value / orientacionComercialIPCAnioOrigen[49].Value) * (orientacionComercialTCAnioOrigen[49].Value / orientacionComercialTCAnioDestino[49].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[49].Value)) ? 0 : (orientacionComercialCPIAnioDestino[49].Value / orientacionComercialCPIAnioOrigen[49].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato65) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato65) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[50].Value) || decimalIsZero(orientacionComercialTCAnioDestino[50].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[50].Value / orientacionComercialIPCAnioOrigen[50].Value) * (orientacionComercialTCAnioOrigen[50].Value / orientacionComercialTCAnioDestino[50].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[50].Value)) ? 0 : (orientacionComercialCPIAnioDestino[50].Value / orientacionComercialCPIAnioOrigen[50].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato66) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato66) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[51].Value) || decimalIsZero(orientacionComercialTCAnioDestino[51].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[51].Value / orientacionComercialIPCAnioOrigen[51].Value) * (orientacionComercialTCAnioOrigen[51].Value / orientacionComercialTCAnioDestino[51].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[51].Value)) ? 0 : (orientacionComercialCPIAnioDestino[51].Value / orientacionComercialCPIAnioOrigen[51].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato67) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato67) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[52].Value) || decimalIsZero(orientacionComercialTCAnioDestino[52].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[52].Value / orientacionComercialIPCAnioOrigen[52].Value) * (orientacionComercialTCAnioOrigen[52].Value / orientacionComercialTCAnioDestino[52].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[52].Value)) ? 0 : (orientacionComercialCPIAnioDestino[52].Value / orientacionComercialCPIAnioOrigen[52].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato68) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato68) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[53].Value) || decimalIsZero(orientacionComercialTCAnioDestino[53].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[53].Value / orientacionComercialIPCAnioOrigen[53].Value) * (orientacionComercialTCAnioOrigen[53].Value / orientacionComercialTCAnioDestino[53].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[53].Value)) ? 0 : (orientacionComercialCPIAnioDestino[53].Value / orientacionComercialCPIAnioOrigen[53].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato69) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato69) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[54].Value) || decimalIsZero(orientacionComercialTCAnioDestino[54].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[54].Value / orientacionComercialIPCAnioOrigen[54].Value) * (orientacionComercialTCAnioOrigen[54].Value / orientacionComercialTCAnioDestino[54].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[54].Value)) ? 0 : (orientacionComercialCPIAnioDestino[54].Value / orientacionComercialCPIAnioOrigen[54].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato70) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato70) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[55].Value) || decimalIsZero(orientacionComercialTCAnioDestino[55].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[55].Value / orientacionComercialIPCAnioOrigen[55].Value) * (orientacionComercialTCAnioOrigen[55].Value / orientacionComercialTCAnioDestino[55].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[55].Value)) ? 0 : (orientacionComercialCPIAnioDestino[55].Value / orientacionComercialCPIAnioOrigen[55].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato71) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato71) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[56].Value) || decimalIsZero(orientacionComercialTCAnioDestino[56].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[56].Value / orientacionComercialIPCAnioOrigen[56].Value) * (orientacionComercialTCAnioOrigen[56].Value / orientacionComercialTCAnioDestino[56].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[56].Value)) ? 0 : (orientacionComercialCPIAnioDestino[56].Value / orientacionComercialCPIAnioOrigen[56].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato72) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato72) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[57].Value) || decimalIsZero(orientacionComercialTCAnioDestino[57].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[57].Value / orientacionComercialIPCAnioOrigen[57].Value) * (orientacionComercialTCAnioOrigen[57].Value / orientacionComercialTCAnioDestino[57].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[57].Value)) ? 0 : (orientacionComercialCPIAnioDestino[57].Value / orientacionComercialCPIAnioOrigen[57].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato73) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato73) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[58].Value) || decimalIsZero(orientacionComercialTCAnioDestino[58].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[58].Value / orientacionComercialIPCAnioOrigen[58].Value) * (orientacionComercialTCAnioOrigen[58].Value / orientacionComercialTCAnioDestino[58].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[58].Value)) ? 0 : (orientacionComercialCPIAnioDestino[58].Value / orientacionComercialCPIAnioOrigen[58].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato74) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato74) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[59].Value) || decimalIsZero(orientacionComercialTCAnioDestino[59].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[59].Value / orientacionComercialIPCAnioOrigen[59].Value) * (orientacionComercialTCAnioOrigen[59].Value / orientacionComercialTCAnioDestino[59].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[59].Value)) ? 0 : (orientacionComercialCPIAnioDestino[59].Value / orientacionComercialCPIAnioOrigen[59].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato75) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato75) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[60].Value) || decimalIsZero(orientacionComercialTCAnioDestino[60].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[60].Value / orientacionComercialIPCAnioOrigen[60].Value) * (orientacionComercialTCAnioOrigen[60].Value / orientacionComercialTCAnioDestino[60].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[60].Value)) ? 0 : (orientacionComercialCPIAnioDestino[60].Value / orientacionComercialCPIAnioOrigen[60].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato76) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato76) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[61].Value) || decimalIsZero(orientacionComercialTCAnioDestino[61].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[61].Value / orientacionComercialIPCAnioOrigen[61].Value) * (orientacionComercialTCAnioOrigen[61].Value / orientacionComercialTCAnioDestino[61].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[61].Value)) ? 0 : (orientacionComercialCPIAnioDestino[61].Value / orientacionComercialCPIAnioOrigen[61].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato77) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato77) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[62].Value) || decimalIsZero(orientacionComercialTCAnioDestino[62].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[62].Value / orientacionComercialIPCAnioOrigen[62].Value) * (orientacionComercialTCAnioOrigen[62].Value / orientacionComercialTCAnioDestino[62].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[62].Value)) ? 0 : (orientacionComercialCPIAnioDestino[62].Value / orientacionComercialCPIAnioOrigen[62].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato78) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato78) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[63].Value) || decimalIsZero(orientacionComercialTCAnioDestino[63].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[63].Value / orientacionComercialIPCAnioOrigen[63].Value) * (orientacionComercialTCAnioOrigen[63].Value / orientacionComercialTCAnioDestino[63].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[63].Value)) ? 0 : (orientacionComercialCPIAnioDestino[63].Value / orientacionComercialCPIAnioOrigen[63].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato79) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato79) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[64].Value) || decimalIsZero(orientacionComercialTCAnioDestino[64].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[64].Value / orientacionComercialIPCAnioOrigen[64].Value) * (orientacionComercialTCAnioOrigen[64].Value / orientacionComercialTCAnioDestino[64].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[64].Value)) ? 0 : (orientacionComercialCPIAnioDestino[64].Value / orientacionComercialCPIAnioOrigen[64].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato80) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato80) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[65].Value) || decimalIsZero(orientacionComercialTCAnioDestino[65].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[65].Value / orientacionComercialIPCAnioOrigen[65].Value) * (orientacionComercialTCAnioOrigen[65].Value / orientacionComercialTCAnioDestino[65].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[65].Value)) ? 0 : (orientacionComercialCPIAnioDestino[65].Value / orientacionComercialCPIAnioOrigen[65].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato81) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato81) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[66].Value) || decimalIsZero(orientacionComercialTCAnioDestino[66].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[66].Value / orientacionComercialIPCAnioOrigen[66].Value) * (orientacionComercialTCAnioOrigen[66].Value / orientacionComercialTCAnioDestino[66].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[66].Value)) ? 0 : (orientacionComercialCPIAnioDestino[66].Value / orientacionComercialCPIAnioOrigen[66].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato82) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato82) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[67].Value) || decimalIsZero(orientacionComercialTCAnioDestino[67].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[67].Value / orientacionComercialIPCAnioOrigen[67].Value) * (orientacionComercialTCAnioOrigen[67].Value / orientacionComercialTCAnioDestino[67].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[67].Value)) ? 0 : (orientacionComercialCPIAnioDestino[67].Value / orientacionComercialCPIAnioOrigen[67].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato83) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato83) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[68].Value) || decimalIsZero(orientacionComercialTCAnioDestino[68].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[68].Value / orientacionComercialIPCAnioOrigen[68].Value) * (orientacionComercialTCAnioOrigen[68].Value / orientacionComercialTCAnioDestino[68].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[68].Value)) ? 0 : (orientacionComercialCPIAnioDestino[68].Value / orientacionComercialCPIAnioOrigen[68].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato84) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato84) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[69].Value) || decimalIsZero(orientacionComercialTCAnioDestino[69].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[69].Value / orientacionComercialIPCAnioOrigen[69].Value) * (orientacionComercialTCAnioOrigen[69].Value / orientacionComercialTCAnioDestino[69].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[69].Value)) ? 0 : (orientacionComercialCPIAnioDestino[69].Value / orientacionComercialCPIAnioOrigen[69].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato85) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato85) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[70].Value) || decimalIsZero(orientacionComercialTCAnioDestino[70].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[70].Value / orientacionComercialIPCAnioOrigen[70].Value) * (orientacionComercialTCAnioOrigen[70].Value / orientacionComercialTCAnioDestino[70].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[70].Value)) ? 0 : (orientacionComercialCPIAnioDestino[70].Value / orientacionComercialCPIAnioOrigen[70].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato86) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato86) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[71].Value) || decimalIsZero(orientacionComercialTCAnioDestino[71].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[71].Value / orientacionComercialIPCAnioOrigen[71].Value) * (orientacionComercialTCAnioOrigen[71].Value / orientacionComercialTCAnioDestino[71].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[71].Value)) ? 0 : (orientacionComercialCPIAnioDestino[71].Value / orientacionComercialCPIAnioOrigen[71].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato87) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato87) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[72].Value) || decimalIsZero(orientacionComercialTCAnioDestino[72].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[72].Value / orientacionComercialIPCAnioOrigen[72].Value) * (orientacionComercialTCAnioOrigen[72].Value / orientacionComercialTCAnioDestino[72].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[72].Value)) ? 0 : (orientacionComercialCPIAnioDestino[72].Value / orientacionComercialCPIAnioOrigen[72].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato88) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato88) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[73].Value) || decimalIsZero(orientacionComercialTCAnioDestino[73].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[73].Value / orientacionComercialIPCAnioOrigen[73].Value) * (orientacionComercialTCAnioOrigen[73].Value / orientacionComercialTCAnioDestino[73].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[73].Value)) ? 0 : (orientacionComercialCPIAnioDestino[73].Value / orientacionComercialCPIAnioOrigen[73].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato89) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato89) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[74].Value) || decimalIsZero(orientacionComercialTCAnioDestino[74].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[74].Value / orientacionComercialIPCAnioOrigen[74].Value) * (orientacionComercialTCAnioOrigen[74].Value / orientacionComercialTCAnioDestino[74].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[74].Value)) ? 0 : (orientacionComercialCPIAnioDestino[74].Value / orientacionComercialCPIAnioOrigen[74].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato90) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato90) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[75].Value) || decimalIsZero(orientacionComercialTCAnioDestino[75].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[75].Value / orientacionComercialIPCAnioOrigen[75].Value) * (orientacionComercialTCAnioOrigen[75].Value / orientacionComercialTCAnioDestino[75].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[75].Value)) ? 0 : (orientacionComercialCPIAnioDestino[75].Value / orientacionComercialCPIAnioOrigen[75].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato91) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato91) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[76].Value) || decimalIsZero(orientacionComercialTCAnioDestino[76].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[76].Value / orientacionComercialIPCAnioOrigen[76].Value) * (orientacionComercialTCAnioOrigen[76].Value / orientacionComercialTCAnioDestino[76].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[76].Value)) ? 0 : (orientacionComercialCPIAnioDestino[76].Value / orientacionComercialCPIAnioOrigen[76].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato92) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato92) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[77].Value) || decimalIsZero(orientacionComercialTCAnioDestino[77].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[77].Value / orientacionComercialIPCAnioOrigen[77].Value) * (orientacionComercialTCAnioOrigen[77].Value / orientacionComercialTCAnioDestino[77].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[77].Value)) ? 0 : (orientacionComercialCPIAnioDestino[77].Value / orientacionComercialCPIAnioOrigen[77].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato93) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato93) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[78].Value) || decimalIsZero(orientacionComercialTCAnioDestino[78].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[78].Value / orientacionComercialIPCAnioOrigen[78].Value) * (orientacionComercialTCAnioOrigen[78].Value / orientacionComercialTCAnioDestino[78].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[78].Value)) ? 0 : (orientacionComercialCPIAnioDestino[78].Value / orientacionComercialCPIAnioOrigen[78].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato94) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato94) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[79].Value) || decimalIsZero(orientacionComercialTCAnioDestino[79].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[79].Value / orientacionComercialIPCAnioOrigen[79].Value) * (orientacionComercialTCAnioOrigen[79].Value / orientacionComercialTCAnioDestino[79].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[79].Value)) ? 0 : (orientacionComercialCPIAnioDestino[79].Value / orientacionComercialCPIAnioOrigen[79].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDato95) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDato95) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                        ...
                                                        else if (IfDato0Param.StartsWith(prefixTP))
                                                        {
                                                            totParMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDato0.ToString() });
                                                        }
                                                    }
                                                }
                                                else // presupuesto
                                                {
                                                    ...
                                                    else if (informacionFinancieroDetalleParametroVNOrigen != null && informacionFinancieroDetalleParametroVNOrigen.Count == 2)
                                                    {
                                                        ...
                                                        if (IfDato0Param.StartsWith(prefixIng))
                                                        {
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato2.ToString());
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato2.ToString());
                                                            ingMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDDato0.ToString() });
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = perAntNac, ValorExt = perAntExt, ValorTotal = perAntTotal });
                                                            //Enero
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            //Octubre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            //Noviembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            ingMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            //Calculo Totales por Mes
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            for (int i = 2; i < ingMes.Count; i++)
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas2
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas3
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            ingAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            //Total por año
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                            for (int i = 0; i < ingAnio.Count; i++)
                                                        ...
                                                        {
                                                            adqMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDDato0, TituloExt = filaMonedaExtranjera.IfDDato0 });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato2);
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = perAntNac, ValorExt = perAntExt, ValorTotal = perAntTotal });
                                                            //Enero
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            //Octubre
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            //Noviembre
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            adqMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            //Calculo Totales por Mes
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            for (int i = 2; i < adqMes.Count; i++)
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas2
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas3
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            adqAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            //Total por año
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                            for (int i = 0; i < adqAnio.Count; i++)
                                                        ...
                                                        {
                                                            consMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDDato0.ToString() });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato2);
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = perAntNac, ValorExt = perAntExt });
                                                            //Enero
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            InsertarTraceLog(iniToken, "facCorrMonNac=" + facCorrMonNac + ",facCorrMonNac=" + facCorrMonNac + ", filaMonedaNacional.IfDato5=" + filaMonedaNacional.IfDDato5 + ", stringNumberFormatFromDB(filaMonedaNacional.IfDDato5)=" + stringNumberFormatFromDB(filaMonedaNacional.IfDDato5) + ", stringToDecimalFromDB(filaMonedaNacional.IfDDato5)=" + stringToDecimalFromDB(filaMonedaNacional.IfDDato5), usuario);
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            //Octubre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            //Noviembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            consMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas2
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas3
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            consAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                            for (int i = 0; i < consAnio.Count; i++)
                                                            {
                                                        ...
                                                        {
                                                            admMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDDato0.ToString() });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato2);
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = perAntNac, ValorExt = perAntExt });
                                                            //Enero
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            //Octubre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            //Noviembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            admMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            for (int i = 2; i < admMes.Count; i++)
                                                            {
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas2
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas3
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            admAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                            for (int i = 0; i < admAnio.Count; i++)
                                                            {
                                                        ...
                                                        {
                                                            contMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDDato0.ToString() });
                                                            decimal perAntNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato2);
                                                            decimal perAntExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato2);
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = perAntNac, ValorExt = perAntExt });
                                                            //Enero
                                                            decimal facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[0].Value) || decimalIsZero(orientacionComercialTCMesDestino[0].Value)) ? 0 : ((orientacionComercialIPCMesDestino[0].Value / orientacionComercialIPCMesOrigen[0].Value) * (orientacionComercialTCMesOrigen[0].Value / orientacionComercialTCMesDestino[0].Value)));
                                                            decimal facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[0].Value)) ? 0 : (orientacionComercialCPIMesDestino[0].Value / orientacionComercialCPIMesOrigen[0].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato3) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato3) * facCorrMonExt, ValorTotal = 0 });
                                                            //Febrero
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[1].Value) || decimalIsZero(orientacionComercialTCMesDestino[1].Value)) ? 0 : ((orientacionComercialIPCMesDestino[1].Value / orientacionComercialIPCMesOrigen[1].Value) * (orientacionComercialTCMesOrigen[1].Value / orientacionComercialTCMesDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[1].Value)) ? 0 : (orientacionComercialCPIMesDestino[1].Value / orientacionComercialCPIMesOrigen[1].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato4) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato4) * facCorrMonExt, ValorTotal = 0 });
                                                            //Marzo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[2].Value) || decimalIsZero(orientacionComercialTCMesDestino[2].Value)) ? 0 : ((orientacionComercialIPCMesDestino[2].Value / orientacionComercialIPCMesOrigen[2].Value) * (orientacionComercialTCMesOrigen[2].Value / orientacionComercialTCMesDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[2].Value)) ? 0 : (orientacionComercialCPIMesDestino[2].Value / orientacionComercialCPIMesOrigen[2].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato5) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato5) * facCorrMonExt, ValorTotal = 0 });
                                                            //Abril
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[3].Value) || decimalIsZero(orientacionComercialTCMesDestino[3].Value)) ? 0 : ((orientacionComercialIPCMesDestino[3].Value / orientacionComercialIPCMesOrigen[3].Value) * (orientacionComercialTCMesOrigen[3].Value / orientacionComercialTCMesDestino[3].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[3].Value)) ? 0 : (orientacionComercialCPIMesDestino[3].Value / orientacionComercialCPIMesOrigen[3].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato6) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato6) * facCorrMonExt, ValorTotal = 0 });
                                                            //Mayo
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[4].Value) || decimalIsZero(orientacionComercialTCMesDestino[4].Value)) ? 0 : ((orientacionComercialIPCMesDestino[4].Value / orientacionComercialIPCMesOrigen[4].Value) * (orientacionComercialTCMesOrigen[4].Value / orientacionComercialTCMesDestino[4].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[4].Value)) ? 0 : (orientacionComercialCPIMesDestino[4].Value / orientacionComercialCPIMesOrigen[4].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato7) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato7) * facCorrMonExt, ValorTotal = 0 });
                                                            //Junio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[5].Value) || decimalIsZero(orientacionComercialTCMesDestino[5].Value)) ? 0 : ((orientacionComercialIPCMesDestino[5].Value / orientacionComercialIPCMesOrigen[5].Value) * (orientacionComercialTCMesOrigen[5].Value / orientacionComercialTCMesDestino[5].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[5].Value)) ? 0 : (orientacionComercialCPIMesDestino[5].Value / orientacionComercialCPIMesOrigen[5].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato8) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato8) * facCorrMonExt, ValorTotal = 0 });
                                                            //Julio
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[6].Value) || decimalIsZero(orientacionComercialTCMesDestino[6].Value)) ? 0 : ((orientacionComercialIPCMesDestino[6].Value / orientacionComercialIPCMesOrigen[6].Value) * (orientacionComercialTCMesOrigen[6].Value / orientacionComercialTCMesDestino[6].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[6].Value)) ? 0 : (orientacionComercialCPIMesDestino[6].Value / orientacionComercialCPIMesOrigen[6].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato9) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato9) * facCorrMonExt, ValorTotal = 0 });
                                                            //Agosto
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[7].Value) || decimalIsZero(orientacionComercialTCMesDestino[7].Value)) ? 0 : ((orientacionComercialIPCMesDestino[7].Value / orientacionComercialIPCMesOrigen[7].Value) * (orientacionComercialTCMesOrigen[7].Value / orientacionComercialTCMesDestino[7].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[7].Value)) ? 0 : (orientacionComercialCPIMesDestino[7].Value / orientacionComercialCPIMesOrigen[7].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato10) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato10) * facCorrMonExt, ValorTotal = 0 });
                                                            //Septiembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[8].Value) || decimalIsZero(orientacionComercialTCMesDestino[8].Value)) ? 0 : ((orientacionComercialIPCMesDestino[8].Value / orientacionComercialIPCMesOrigen[8].Value) * (orientacionComercialTCMesOrigen[8].Value / orientacionComercialTCMesDestino[8].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[8].Value)) ? 0 : (orientacionComercialCPIMesDestino[8].Value / orientacionComercialCPIMesOrigen[8].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato11) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato11) * facCorrMonExt, ValorTotal = 0 });
                                                            //Octubre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[9].Value) || decimalIsZero(orientacionComercialTCMesDestino[9].Value)) ? 0 : ((orientacionComercialIPCMesDestino[9].Value / orientacionComercialIPCMesOrigen[9].Value) * (orientacionComercialTCMesOrigen[9].Value / orientacionComercialTCMesDestino[9].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[9].Value)) ? 0 : (orientacionComercialCPIMesDestino[9].Value / orientacionComercialCPIMesOrigen[9].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato12) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato12) * facCorrMonExt, ValorTotal = 0 });
                                                            //Noviembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[10].Value) || decimalIsZero(orientacionComercialTCMesDestino[10].Value)) ? 0 : ((orientacionComercialIPCMesDestino[10].Value / orientacionComercialIPCMesOrigen[10].Value) * (orientacionComercialTCMesOrigen[10].Value / orientacionComercialTCMesDestino[10].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[10].Value)) ? 0 : (orientacionComercialCPIMesDestino[10].Value / orientacionComercialCPIMesOrigen[10].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato13) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato13) * facCorrMonExt, ValorTotal = 0 });
                                                            //Diciembre
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCMesOrigen[11].Value) || decimalIsZero(orientacionComercialTCMesDestino[11].Value)) ? 0 : ((orientacionComercialIPCMesDestino[11].Value / orientacionComercialIPCMesOrigen[11].Value) * (orientacionComercialTCMesOrigen[11].Value / orientacionComercialTCMesDestino[11].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIMesOrigen[11].Value)) ? 0 : (orientacionComercialCPIMesDestino[11].Value / orientacionComercialCPIMesOrigen[11].Value));
                                                            contMes.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato14) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato14) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacMes = 0;
                                                            decimal totalValorExtMes = 0;
                                                            for (int i = 2; i < contMes.Count; i++)
                                                            {
                                                            ...
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[0].Value) || decimalIsZero(orientacionComercialTCAnioDestino[0].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[0].Value / orientacionComercialIPCAnioOrigen[0].Value) * (orientacionComercialTCAnioOrigen[0].Value / orientacionComercialTCAnioDestino[0].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[0].Value)) ? 0 : (orientacionComercialCPIAnioDestino[0].Value / orientacionComercialCPIAnioOrigen[0].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato16) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato16) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas2
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[1].Value) || decimalIsZero(orientacionComercialTCAnioDestino[1].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[1].Value / orientacionComercialIPCAnioOrigen[1].Value) * (orientacionComercialTCAnioOrigen[1].Value / orientacionComercialTCAnioDestino[1].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[1].Value)) ? 0 : (orientacionComercialCPIAnioDestino[1].Value / orientacionComercialCPIAnioOrigen[1].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato17) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato17) * facCorrMonExt, ValorTotal = 0 });
                                                            //AñoMas3
                                                            facCorrMonNac = ((decimalIsZero(orientacionComercialIPCAnioOrigen[2].Value) || decimalIsZero(orientacionComercialTCAnioDestino[2].Value)) ? 0 : ((orientacionComercialIPCAnioDestino[2].Value / orientacionComercialIPCAnioOrigen[2].Value) * (orientacionComercialTCAnioOrigen[2].Value / orientacionComercialTCAnioDestino[2].Value)));
                                                            facCorrMonExt = ((decimalIsZero(orientacionComercialCPIAnioOrigen[2].Value)) ? 0 : (orientacionComercialCPIAnioDestino[2].Value / orientacionComercialCPIAnioOrigen[2].Value));
                                                            contAnio.Add(new Presupuesto.CellValue { ValorNac = stringToDecimalFromDB(filaMonedaNacional.IfDDato18) * facCorrMonNac, ValorExt = stringToDecimalFromDB(filaMonedaExtranjera.IfDDato18) * facCorrMonExt, ValorTotal = 0 });
                                                            decimal totalValorNacAnio = 0;
                                                            decimal totalValorExtAnio = 0;
                                                            for (int i = 0; i < contAnio.Count; i++)
                                                            {
                                                        ...
                                                        {
                                                            totParMes.Add(new Presupuesto.CellValue { Titulo = IfDato0Param, TituloNac = filaMonedaNacional.IfDDato0.ToString(), TituloExt = filaMonedaExtranjera.IfDDato0.ToString() });
                                                        }
                                                    }
                                                }
                                            }
                ...
                try
                {
                    ...
                    if (respuesta != null && !string.IsNullOrEmpty(respuesta.Trim()))
                    {
                        if (respuesta.Split('|') != null && respuesta.Split('|').Length >= 2)
                        {
                            ...
                            if (!string.IsNullOrEmpty(ParametroVNToken))
                            {
                                GenerarVersionParametroVNToken(objConnection, ParametroVNToken);
                            }
                        }
